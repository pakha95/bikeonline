...
function modal(e) {
	...
	e.cModal = function(t) {
		var n = {
				...
				//template: '<div class="modal-box modal-type-primary"><div class="modal-inner"><div class="modal-title"><a class="modal-close-btn"></a></div><div class="modal-text"></div><div class="modal-buttons"></div></div></div>',
				template: '<div class="modal-box modal-type-primary"><div class="modal-inner"><div class="modal-title"></div><div class="modal-text"></div><div class="modal-buttons"></div></div></div>',
				_classes: {
					box: ".modal-box",
			...
			u = {
				...
				_modalConent: function() {
					...
					if (t.buttons || t.buttons != null) {
						...
						switch (t.type) {
							case "alert":
								c = '<a class="modal-btn btn-red' + (t.buttons[0].addClass ? " " + t.buttons[0].addClass : "") + '">' + a.ok + "</a>";
								break;
							case "confirm":
