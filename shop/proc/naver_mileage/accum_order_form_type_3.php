<?php ob_start(); ?>
<tr class="naver-mileage-accum-place m_list">
	<th style="line-height: 25px; padding: 0;">적립금<br/>적립위치</th>
	<td style="line-height: 18px; padding: 5px; font-size: 12px;">
...
<tr class="naver-mileage-accum-set m_list" style="height: 90px;">
	<th style="line-height: 25px; padding: 20px 0 20px 0;">네이버<br/>마일리지 <img src="<?php echo $GLOBALS['cfg']['rootDir']; ?>/proc/naver_mileage/images/n_mileage_on.png"/></th>
