...
<form name="frmAGS_pay" method="post" action="https://www.allthegate.com/payment/mobilev2/intro.jsp">
<!-- ★ => 필수 -->
...
<input type=hidden name=RtnUrl value="<? echo ProtocolPortDomain().$cfg['rootDir'].'/order/card/agspay/mobile/nscreen_card_return.php?page_type='.$page_type ?>">	<!-- ★성공 URL (150) - 성공 URL은 반드시 상점의 AGS_pay_ing.php의 전체 경로로 맞춰 주시기 바랍니다. ex)http://www.allthegate.com/mall/AGS_pay_ing.php -->
<input type=hidden name=CancelUrl value="<? echo ProtocolPortDomain().$cfg['rootDir'].'/order/order.php?pc'; ?>">	<!-- ★취소 URL (150) - 객이 취소를 눌렀을 경우의 이동 URL 경로로 전체 경로로 맞춰 주시기 입니다. ex)http://www.allthegate.com/mall/AGS_pay_cancel.php -->
...
<input type=hidden name=MallPage value="<?php echo $cfg['rootDir']; ?>/order/card/agspay/mobile/AGS_VirAcctResult.php">	<!-- ★통보페이지 (100) -->
