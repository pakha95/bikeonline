...
<input type=hidden name=CancelUrl value="<? echo ProtocolPortDomain().'/m/ord/order.php'; ?>">	<!-- ★취소 URL (150) - 객이 취소를 눌렀을 경우의 이동 URL 경로로 전체 경로로 맞춰 주시기 입니다. ex)http://www.allthegate.com/mall/AGS_pay_cancel.php -->
