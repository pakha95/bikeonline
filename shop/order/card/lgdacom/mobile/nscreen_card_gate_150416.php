...
// 결제 정보 설정 (모바일용 PG 설정시 모바일용것으로, 모바일용 PG 미설정시 PC용 설정으로)
...
$payReqMap['LGD_KVPMISPAUTOAPPYN']		= 'Y';						// Y: 안드로이드에서 ISP신용카드 결제시, 고객사에서 'App To App' 방식으로 국민, BC카드사에서 받은 결제 승인을 받고 고객사의 앱을 실행하고자 할때 사용
