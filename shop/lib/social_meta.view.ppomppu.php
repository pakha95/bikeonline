<?
$_meta_site_info['ppomppu'] = array('name'=>'»Ë»Ñ','url'=>'http://social.ppomppu.co.kr');

// »Ë»Ñ ºä
class social_meta_view_ppomppu extends social_meta_view {

	var $data = array();

	function social_meta_view_ppomppu() {
		$this->goods_only = 'A';
		$this->encode = 'UTF-8';
	}
