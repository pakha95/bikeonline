<?
$_meta_site_info['socialmarket'] = array('name'=>'家既付南','url'=>'http://socialmarket.kr');

// 家既付南 轰
class social_meta_view_socialmarket extends social_meta_view {

	var $data = array();

	function social_meta_view_socialmarket() {
		$this->goods_only = 'A';
		$this->encode = 'UTF-8';
	}
