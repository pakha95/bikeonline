<?
$_meta_site_info['metapon'] = array('name'=>'메타폰','url'=>'http://www.metapon.co.kr');

// 메타폰 뷰
class social_meta_view_metapon extends social_meta_view {

	var $data = array();

	function social_meta_view_metapon() {
		$this->goods_only = 'A';
		$this->encode = 'UTF-8';
	}
