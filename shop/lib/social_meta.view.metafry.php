<?
$_meta_site_info['metafry'] = array('name'=>'메타프라이','url'=>'http://www.metafry.com');

// 메타프라이 뷰
class social_meta_view_metafry extends social_meta_view {

	var $data = array();

	function social_meta_view_metafry() {
		$this->goods_only = 'A';
		$this->encode = 'UTF-8';
	}
