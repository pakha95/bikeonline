<?
$_meta_site_info['ticketbene'] = array('name'=>'티켓베네','url'=>'http://ticketbene.com');

// 티켓베네 뷰
class social_meta_view_ticketbene extends social_meta_view {

	var $data = array();

	function social_meta_view_ticketbene() {
		$this->goods_only = 'A';
		$this->encode = 'UTF-8';
	}
