...
class mypage_paymentDetails {
	...
	*/
	...
	{
		$emoney = 0;
		$emoney = $this->order->getEmoneyDiscount() - $this->order->getCancelCompletedEmoney();
	...
	*/
	function getCancelMultiPrice()
	{
		...
		$canceling_RealPrnSettlePrice = ($this->order->getCancelingAmount() > 0) ? $this->getCancelingRealPrnSettleAmount() : 0;
