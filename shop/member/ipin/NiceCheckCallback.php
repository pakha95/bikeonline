	...
	<script type="text/javascript">
		...
		function loadAction()
		{
			...
			if (callType == "findid" || callType == "findpwd") {
				_joinGubunHeader.document.fm.action = '';
				_joinGubunHeader.document.fm.target = '';
				_joinGubunHeader.document.fm.rncheck.value = 'ipin';
				_joinGubunHeader.document.fm.dupeinfo.value = dupeInfo;
				_joinGubunHeader.document.fm.submit();
			}
			else {
