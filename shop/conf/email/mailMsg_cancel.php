...
<TBODY>
<TR>
<TD><IMG src="/shop/admin/img/mail/title_today_order_cancel.gif"></TD></TR>
<TR>
<TD 
...
저희 쇼핑몰을 이용해 주셔서 감사합니다.<BR>고객님께서 주문하신 [{goodsnm}]주문이 구매 목표인원을 달성 하지 못하여 자동 주문 취소 
되었습니다. </DIV>
<DIV 
...
<TR>
<TD bgColor=#f7f7f7 height=60 colSpan=5 align=right><!--{ ? goodstype=='goods'}-->상품합계금액 <B>{=number_format(price * ea)}</B>원 + 배송비 <B>{=number_format(delivery)}</B> = <!--{ / }-->총주문금액 &nbsp;<B 
...
<TR>
<TD height=10><STRONG></STRONG></TD></TR></TBODY></TABLE></DIV></TD></TR>
<TR>
