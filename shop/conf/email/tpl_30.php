...
<TR>
<TD width=640><IMG 
src="/shop/admin/img/mail/mail_bar_reject.gif"></TD></TR></TBODY></TABLE><!--메일 상단 : End --><!--본문 부분 : Start -->
<TABLE cellSpacing=0 cellPadding=0 width=640 border=0>
<TBODY>
<TR>
<TD align=middle>
...
<TD height=20></TD></TR>
<TR>
<TD style="FONT: 9pt/20px 돋움; COLOR: #585858"><STRONG>{mail} 메일주소에 대한 광고성 정보,이벤트 관련 이메일 수신거부가 완료되었습니다.</STRONG>
<BR />
처리완료일 : {agreeDate_year}년 {agreeDate_month}월 {agreeDate_day}일
<BR>
재수신을 원하시는 경우 <A href="http://{cfg.shopUrl}/">마이페이지 > 회원정보수정</a>에서 정보메일수신에 “체크”해 주시기 바랍니다.
