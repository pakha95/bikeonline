...
<TD height=20></TD></TR>
<TR>
<TD style="FONT: 9pt/20px 돋움; COLOR: #585858"><STRONG>{nameOrder} 고객님의 입금을 
확인하였습니다.</STRONG><BR><BR>빠른시일내에 주문하신 상품을 받아보실 수 있도록 노력하겠습니다.<BR></STRONG>저희 쇼핑몰을 
이용해주셔서 감사드리며, 언제나 만족스런 쇼핑을 하실 수 있도록 최선을 다하는 {cfg.shopName}쇼핑몰<A 
href="http://{cfg.shopUrl}/"><FONT 
color=#585858>(<STRONG>http://{cfg.shopUrl}</STRONG>)</FONT></A> 가 
