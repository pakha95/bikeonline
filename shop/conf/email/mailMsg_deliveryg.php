...
<TBODY>
<TR>
<TD><IMG src="/shop/admin/img/mail/mail_bar_delivery.gif"></TD></TR>
<TR>
<TD 
...
저희 쇼핑몰을 이용해 주셔서 감사합니다.<BR>{nameOrder}님께서 주문하신 상품이 배송 중입니다.<BR>주문내역 및 상품정보는 
마이페이지에서 주문/배송조회에서 확인하실 수 있습니다.<BR></DIV>
<DIV 
...
<TR>
<TD>택배사</TD>
<TD>{deliverycomp}</TD></TR>
<TR>
<TD>송장번호</TD>
<TD><A href="{=deliveryurl.deliverycode}" 
target=_blank>{=deliverycode}</A></TD></TR>
<TR>
<TD>배송메세지</TD>
<TD>{memo}</TD></TR>
<TR>
