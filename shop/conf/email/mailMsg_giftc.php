...
저희 쇼핑몰을 이용해 주셔서 감사합니다.<BR>{nameOrder}님께서 주문하신 상품이 주문 접수 되었습니다.<BR>
주문내역 및 쿠폰 정보는 마이페이지에서 주문/배송조회에서 확인하실 수 있습니다.<BR>
쿠폰사용 여부는 판매기간이 종료된 후 마이페이지에서 확인하실 수 있습니다.<BR>
</DIV>
<DIV
...
id=cart_totalprice class=red>{=number_format(cart->totalprice)}</B>원 &nbsp;
</TD></TR>
<TR>
