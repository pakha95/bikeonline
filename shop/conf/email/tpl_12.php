...
<TR>
<TD><!--메일 상단 : Start -->
<DIV><IMG src="/shop/admin/img/mail/mail_bar_drawal.gif"></DIV><!--메일 상단 : End --><!--본문 부분 : Start -->
<TABLE style="MARGIN: 10px 0px" cellSpacing=0 cellPadding=0 width=610 align=center border=0>
<TBODY>
<TR>
<TD>
...
<TBODY>
<TR>
<TD style="FONT: 9pt/20px 돋움; COLOR: #585858" bgColor=#f2f2f2><B>{name}</B> 고객님, 그동안 {cfg.shopName} 쇼핑몰을 이용해 주셔서 대단히 감사합니다.<BR>요청하신대로 {cfg.shopName} 쇼핑몰 회원 탈퇴가 이루어졌습니다.<BR><B>{name}</B> 고객님께 만족스런 쇼핑을 못드려 죄송합니다.<BR>다음 기회에 {cfg.shopName} 쇼핑몰과 더 좋은 만남으로 이루어지길 바랍니다. </TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
