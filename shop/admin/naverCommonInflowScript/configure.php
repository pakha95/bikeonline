...
<form id="common-inflow-script-configure-form" action="<?php echo $cfg['rootDir']; ?>/admin/naverCommonInflowScript/indb.php">
	...
	<div class="common-inflow-script-description">
		<strong>*필독* </strong><br/>
		<p><strong>공통유입스크립트</strong>란, 기존 지식쇼핑, 체크아웃, 마일리지, 검색광고의 프리미엄로그분석 서비스의 유입트래킹이 따로 관리되던 것을 통합하여 관리하기위한 수단입니다.</p>
		<p>
			공통유입스크립트를 설정 하셔야만 네이버부가서비스를 사용할 수 있기 때문에, 공통유입스크립트가 설정되지 않은	가맹점은<br/>
			네이버 체크아웃, 마일리지, 지식쇼핑서비스 사용에 제한이 따를 수 있습니다.<br/>
			단, 지식쇼핑서비스만 사용하는 가맹점의 경우 <u>CPC</u><sup>1)</sup>에서 <u>CPA</u><sup>2)</sup>로의 과금전환 전까지는 설정하지 않으셔도 되지만, CPA과금전환 이후에도<br/>
			공통유입스크립트가 설정되어있지 않으면 서비스사용에 제한이 따를 수 있사오니 되도록 미리 설정하여두시기 바랍니다.
		</p>
		<p>
			1) CPC(Cost per click) : 네이버 지식쇼핑에 노출된 상품을 클릭하였을때 과금되는 형태.<br/>
			2) CPA(Cost per action) : 네이버로부터 유입되어 주문이 일어났을때 과금되는 형태.
		</p>
		<br/>
		<p>
		<strong>네이버공통인증키 확인방법</strong><br/>
		네이버공통인증키는 "네이버쇼핑광고센터 > 정보관리 > 정보수정"에서 확인하실수 있습니다. 만일 네이버공통인증키를 확인하실수 없으시다면 네이버 쇼핑광고센터측으로 네이버공통인증키의 확인방법에 대하여 문의주시기 바랍니다.<br/>
		[쇼핑광고 고객센터] 02)3469-3360&nbsp;&nbsp;&nbsp;[검색광고 고객센터] 1588-5896
		</p>
	</div>
...
<?php } ?>
			...
			<tr>
				...
				<td>
					...
					<div class="extext">
						체크아웃 및 마일리지서비스의 유입경로별 혜택은 네이버광고센터에 등록하신 도메인에 한해서만 적용됩니다.<br/>
