...
<tr>
	...
	<div style="color: #e6008d; font: 11px dotum; margin-top: 5px;">
		<div><strong>주의! '지역명으로 설정', '우편번호로 설정'</strong> 시 새 우편번호만 있는 배송지(구 우편번호 없음)에는 지역별 추가 배송비를 부과할 수 없습니다.</div>
		<div>새 우편번호 정보만 있는 배송지에 지역별 추가 배송비를 부과하려면, 지역명/도로명 설정을 사용해주세요.</div>
	</div>
