...
<tr>
	<td>쇼핑몰설명</td>
	<td colspan="3"><input name="description" class="line" style="width:100%;" value="<?=$cfg['description']?>">
	<div style="margin-top:5px"><span class="small"><font class="extext">쇼핑몰에 대한 간단한 설명을 입력할 수 있습니다.</font></span></div></td>
</tr>
<tr>
	<td>검색엔진 키워드</td>
