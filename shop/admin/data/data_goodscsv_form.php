...
$addFields = array(
	...
	//delivery_type 안내문구에 배송정책 추가
	if ($fields['delivery_type']['desc']) {
		$fields['delivery_type']['desc'] = "기본배송비 사용(0), 무료배송(1), 착불배송비(3), 고정배송비(4), 수량별 배송비(5) 중 택일 입력. 기본값 - 기본배송비 사용(0)";
	}
...
<tr>
	...
	<td>
		<a href="../data/csv_goods.xlsx"><img src="../img/btn_goodcsv_sample.gif" alt="상품CSV 샘플파일 다운로드"></a>
...
<tr>
	<td>상품 CSV 파일 올리기</td>
	<td>
		<input type="file" name="file_excel" size="45" required label="CSV 파일" accept=".csv"> &nbsp;&nbsp; <span class="noline"><input type=image src="../img/btn_regist_s.gif" align="absmiddle"></span>
