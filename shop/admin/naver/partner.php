...
<div style="padding-top:5"><b>1) 기존 버전(v1.0, v2.0) 이용 고객의 경우 2017년 11월 20일(예정)까지 정상적으로 이용하실 수 있습니다.</b></font></div>
<div style="padding-top:5"><font class=g9 color=666666>&nbsp;&nbsp;&nbsp;&nbsp;- 2017년 11월 20일(예정)까지는 기존의 사용하시던 1.0, 2.0 버전으로도 네이버 쇼핑 서비스를 정상적으로 이용하실 수 있습니다.</font></div><br>
<div style="padding-top:5"><b>2) 단, 2017년 11월 20일(예정) 이후에는 기존 버전 (v1.0, v2.0)의 서비스가 종료되므로 해당 일자 이전에 v3.0으로 버전을 변경하여야 합니다.</b></font></div>
<div style="padding-top:5"><font class=g9 color=666666>&nbsp;&nbsp;&nbsp;&nbsp;*버전 변경 방법*&nbsp;</font></div>
<div style="padding-top:5"><font class=g9 color=666666>&nbsp;&nbsp;&nbsp;&nbsp;먼저 네이버 쇼핑파트너존 > 상품관리 > 상품정보 수신 현황 > 쇼핑몰 상품DB URL에서 3.0으로 직접 설정합니다.<a href="https://adcenter.shopping.naver.com/member/login/form.nhn" target="_blank"><font color=blue>[설정하기]</font></a></font></div>
