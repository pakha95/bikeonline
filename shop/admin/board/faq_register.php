...
function chkEncoding(form) {
	form.encodeQuestion.value = encodeURIComponent(form.question.value);
	form.encodeDescant.value = encodeURIComponent(form.descant.value);
	form.encodeAnswer.value = encodeURIComponent(form.answer.value);
...
<form method=post action="faq_indb.php" enctype="multipart/form-data" onsubmit="return chkEncoding(this)">
<input type=hidden name=mode value="<?=$_GET[mode]?>">
<input type=hidden name=sno value="<?=$_GET[sno]?>">
<input type=hidden name=returnUrl value="<?=$returnUrl?>">
<input type="hidden" name="encode" value="">
<input type="hidden" name="encodeQuestion" value="">
<input type="hidden" name="encodeDescant" value="">
<input type="hidden" name="encodeAnswer" value="">
