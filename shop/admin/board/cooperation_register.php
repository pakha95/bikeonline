...
function chkEncoding(form) {
	form.encodeReply.value = encodeURIComponent(form.reply.value);
...
<form method=post action="cooperation_indb.php" enctype="multipart/form-data" onsubmit="return chkEncoding(this)">
<input type=hidden name=mode value="<?=$_GET[mode]?>">
<input type=hidden name=sno value="<?=$_GET[sno]?>">
<input type=hidden name=returnUrl value="<?=$returnUrl?>">
<input type="hidden" name="encode" value="">
<input type="hidden" name="encodeReply" value="">
