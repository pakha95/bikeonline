...
<form name="frmNaverCheckout" method="post" target="processLayerForm">
	...
	if (in_array(getCheckoutOrderStatus($p_order), array('취소요청','교환요청','반품요청'))) {
		$claimRequestAmount += $p_order['calculated_payAmount'];
	}
	?>
...
<!-- 결제정보 -->
	...
	<tr>
		<td>결제금액</td>
		<td align=right><font color=0074BA class=ver8><b><?=number_format( $Order['GeneralPaymentAmount'] - $claimRequestAmount + $Order['NaverMileagePaymentAmount'] + $Order['ChargeAmountPaymentAmount'] + $Order['CheckoutAccumulationPaymentAmount'] );?></b></font>원</td>
		<td>
			<img src="../img/arrow_gray.gif" align="absmiddle">
			<font class="small" color="#444444">
			일반결제 (<font color=0074BA class=ver81><?=number_format($Order['GeneralPaymentAmount'] - $claimRequestAmount)?></font>원)
