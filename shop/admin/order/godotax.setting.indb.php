...
$config_pay['tax']['period'] = (string)$_POST['period'];
...
//세금계산서 이용안내 문구
$cfgtaxGuide['guideWords'] = $_POST['guideWords'];
$cfgtaxGuide['endWords'] = $_POST['endWords'];
$cfgtaxGuidePath = '../../conf/config.taxGuide.php';
$qfile->open($cfgtaxGuidePath);
$qfile->write("<?php \n");
$qfile->write("\$cfgtaxGuide = array( \n");
foreach ($cfgtaxGuide as $key => $value) {
	$qfile->write("'$key' => '$value', \n");
}
$qfile->write("); \n");
$qfile->write("?>");
$qfile->close();
unset($_POST['guideWords']);
unset($_POST['endWords']);
msg("저장되었습니다");
