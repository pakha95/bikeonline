...
<tr>
	<td style="text-align: left; padding: 3px 0px 3px 0px;">선택한 주문건을 : <img src="../img/orderSmsSendSmall.png" alt="주문자에게 SMS발송" border="0" class="hand" onclick="javascript:openOrderSmsPopup(document.frmList, 'chk[enamoo][]');" align="absmiddle" /></td>
</tr>
</table>
