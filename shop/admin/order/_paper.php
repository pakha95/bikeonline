...
<DIV class="notprint">
<div style="padding-left:63px"><font color=#007fc8>※ <font class=small1>인쇄시 직인(도장이미지)도 인쇄되려면 아래와 같이 설정되어 있어야 가능합니다.</div>
<div style="padding-top:3px"></div>
<div style="padding-left:80px">1) 인터넷 익스플로러 : 브라우저의 [도구 메뉴]-[인터넷옵션]-[고급]-[인쇄] 에서 [배경색 및 이미지 인쇄] 체크</div>
<div style="padding-top:3px"></div>
<div style="padding-left:80px">2) 크롬 : 인쇄 미리보기 창에서 [설정 더보기] - [옵션] 에서 [배경 그래픽] 체크</div>
