...
<tr>
	<td>주문쿠폰 할인방법</td>
	<td>
		<input type=radio name="cfgCoupon[coupon]" value="0" class=null <?=$checked['coupon'][0]?>> 주문서 총 결제금액에 할인 금액 적용
		<input type=radio name="cfgCoupon[coupon]" value="1" class=null <?=$checked['coupon'][1]?>> 쿠폰 할인 대상 상품에만 할인 금액 적용
	</td>
</tr>
<tr>
	<td colspan=2 bgcolor=white align=left valign=top>
		<div style="padding:3 0 0 15">
			<font  class=extext>주문쿠폰(정액 할인 쿠폰) 사용 시 <br />쿠폰만들기 &gt; 쿠폰사용조건에 설정된 상품에만 할인 금액을 적용할 것인지 혹은, 해당 상품이 포함된 주문서를 기준으로 할인 금액을 적용할 것인지를 설정합니다.</font>
		</div>
		<div style="padding:10 0 0 15;color:#000;">
			'쿠폰 할인 대상 상품에만 할인 금액 적용' 선택 시<br />
			<span style="color:#f00; font-weight:bold;">2016년 03월 31일 이전 제작 무료 스킨</span>을 사용하시는 경우
			<span style="font-weight:bold;text-decoration:underline;">반드시 스킨패치를 적용</span>해야 기능 사용이 가능합니다.
			<a href="http://www.godo.co.kr/customer_center/patch.php?sno=2358" target="_blank" style="color:#0080ff;font-weight:bold;text-decoration:underline;">[패치 바로가기]</a>
		</div>
	<div style="padding-top:10"></div></td>
</tr>
</table>
