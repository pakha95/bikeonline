...
//재고량연동 변경(재고 0되면 자동으로 무한판매)및 문구변경 by jung //////////////////////////////////////
	...
	mysql_query("update ".GD_GOODS." set goodsnm = REPLACE(goodsnm, \"<span class='red_b'>[국내배송]</span>\",\"<span class='green_b'>[해외]</span>\") where (usestock <>'o' or totstock<1) and goodsnm LIKE '%국내배송%' ");
	//mysql_query("update ".GD_GOODS." set goodsnm = REPLACE(goodsnm, $red_b,$green_b) where usestock <>'o' and goodsnm LIKE '%국내배송%' ");
	mysql_query("update ".GD_GOODS." set goodsnm = concat(\"<span class='green_b'>[해외]</span>\",goodsnm) where (usestock ='' and goodsnm NOT LIKE '%해외%' and goodsnm NOT LIKE '%국내배송%') or (usestock IS NULL and goodsnm NOT LIKE '%해외%' and goodsnm NOT LIKE '%국내배송%') or (totstock ='' and goodsnm NOT LIKE '%해외%' and goodsnm NOT LIKE '%국내배송%') or (totstock IS NULL and goodsnm NOT LIKE '%해외%' and goodsnm NOT LIKE '%국내배송%') ");
	mysql_query("update ".GD_GOODS." set goodsnm = concat(\"<span class='red_b'>[국내배송]</span>\",goodsnm) where (totstock > 0 and goodsnm NOT LIKE '%해외%' and goodsnm NOT LIKE '%국내배송%') ");
	mysql_query("update ".GD_GOODS." set goodsnm = REPLACE(goodsnm, \"<span class='green_b'>[해외]</span>\",\"<span class='red_b'>[국내배송]</span>\") where (totstock > 0 and goodsnm LIKE '%해외%') or (usestock ='o' and goodsnm LIKE '%해외%') ");
	//mysql_query("update ".GD_GOODS." set goodssort = REPLACE(goodsnm, \"<span class='green_b'>[해외]</span>\",\"\") where goodsnm LIKE '%해외%' and goodssort ='' ");
	//mysql_query("update ".GD_GOODS." set goodssort = REPLACE(goodsnm, \"<span class='red_b'>[국내배송]</span>\",\"\") where goodsnm LIKE '%국내배송%' and goodssort ='' ");
