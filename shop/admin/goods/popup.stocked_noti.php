...
<div align="center" style="margin-top: 10px; height:38px; background-color:#F7FBFE; border-top:solid 1px #E0E0E0; border-bottom:solid 1px #E0E0E0;">
	<table width="100%" height="35">
		<tr>
			<td align="center"><strong>잔여 SMS포인트: <span style="color:#0070C0"><?=number_format($sms->smsPt, 1)?>건</span></strong>&nbsp;&nbsp;&nbsp;SMS포인트가 부족한 경우 발송되지 않습니다 <a href="javascript:parent.location.href='../member/sms.pay.php';"><img src="../img/btn_smspoint.gif" align="absmiiddle"></a></td>
		</tr>
	</table>
</div>
<div class=button>
