...
<form id="goods-search-form">
	...
	<ul id="goods-sort-guide">
		...
		<li>
			저장한 순서대로 쇼핑몰에 반영이 되지 않을 때는 <a href="./soldout.php" target="_blank">[품절상품 진열설정]</a> 페이지에서 "분류페이지 품절상품 진열 설정"항목을 확인하여 보시기 바랍니다.<br/>
			(본 페이지의 상품리스트에는 품절상품 진열에대한 설정이 반영되지 않습니다.)<br/>
		</li>
		<li>
			품절여부와 관계없이 진열순서 저장 시 에러가 발생하거나, 오작동 시 에는 <a id="optimize-manual-sort" href="javascript:void(0);">[진열순서 최적화]</a>를 클릭하여 본 카테고리의 진열순서를 최적화 시켜보시기 바랍니다.
		</li>
	</ul>
