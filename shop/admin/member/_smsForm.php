	...
	<td valign="top" width="150">
		...
		<tr>
			<td>
				...
				<tr>
					<?php if(isset($dvcomp)&&$dvcomp!="") {?>
						<td id="td_msg" class="td_sms_msg"><textarea name="sms_msg" id="msg" class="area_sms_msg" onkeydown="chkLength(this,'m');" onkeyup="chkLength(this,'m');" onchange="chkLength(this,'m');" style="background-image: url(../img/long_message02_none.gif);" required msgR=""><?php echo $dvMSG; ?></textarea></td>
					<?php }else{ ?>
