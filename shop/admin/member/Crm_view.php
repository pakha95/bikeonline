...
<td valign="top" align="center">
	...
	<td  valign="top">
		...
		<tr>
			...
			<td style="padding-left:8px;"><font class=ver811 color=444444><?=$data['mobile']?> <a href="javascript:confirmReceiveRefuseMessage('sms');"><img src="../img/btn_smsmailsend.gif" align=absmiddle></a><img src="../img/btn_send_info.png" style="vertical-align: middle; cursor:pointer; border: 0px; padding-left: 3px;" onclick="javascript:popup('./popup.sms.sendView.php?sms_phoneNumber=<?php echo $data['mobile']; ?>', '700', '500');" />
