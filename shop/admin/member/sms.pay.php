...
foreach ($div as $v)
{
	...
	// LMS 는 SMS 의 3배!!!
	$unit2 = $unit*3;
	$unit3 = round($unit2/5, 1);

	$smsPrice[$key] = array('useFee' => $useFee, 'unit' => $unit, 'bonus' => $bonus, 'unit2' => $unit2, 'unit3' => $unit3);
...
<div class="title title_top"><font  face=굴림 color=black><b>SMS</b></font> 포인트충전<span>SMS 및 알림톡 사용을 위한 포인트를 충전합니다.</span> <a href="javascript:manual('<?=$guideUrl?>board/view.php?id=member&no=19')"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a></div>
...
<table border=3 bordercolor=#cccccc style="border-collapse:collapse">
	<tr>
		<td width=762 height=50 align=center bgcolor=ADFFFE>잔여포인트 : 현재 <font face=굴림 size=5 color=#04062F><b><u><?=number_format(getSmsPoint(), 1)?></u></b></font></span> Point <a href="javascript:sms_sync();"><img src="../img/btn_point_synchronization.gif" border=0 align=absmiddle hspace=2></a></td>
	</tr>
</table>
</td></tr></table>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle">SMS 및 알림톡 발송서비스는 포인트충전식으로 포인트가 있어야만 발송이 가능합니다.</td></tr>
...
<tr height=25 align=center>
	...
	<td><font class=ver8><?=$v['unit3']?>원/1건</td>
</tr>
<? } ?>
<!-- 별도문의 : Start -->
<tr height=25 align=center>
	...
	<td style="background-color:#E2F5FA;"><font class="ver8"><b>별도협의</b></font></td>
...
<tr><td><img src="../img/icon_list.gif" align="absmiddle">SMS(단문)은 최대 80bytes, LMS(장문)은 최대 2000byte, 알림톡은 최대 1000bytes 까지 전송 됩니다.</td></tr>
