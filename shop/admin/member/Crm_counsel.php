...
list ($total) = $db->fetch("SELECT COUNT(*) FROM ".GD_MEMBER_CRM." WHERE m_no = '".$m_no."'"); # 총 레코드수

if (!$_GET['page_num']) $_GET['page_num'] = 20;
$orderby = ($_GET['sort']) ? $_GET['sort'] : "sno desc"; # 정렬 쿼리
...
<tr>
	<td colspan="10">
		...
		<td valign=bottom align="left"><b><?echo $name?>님의 상담내역</b></td>
		</tr>
...
<tr>
	<td valign="top" colspan="10">
		...
		<td valign="top">
			...
			<td style="font-size:11px;font-family:돋움, 굴림;" width="130"><font class=small1 color=444444><b>상담일</b></td>
			<td style="font-size:11px;font-family:돋움, 굴림;" width="88"><font class=small1 color=444444><b>처리자</b></td>
			<td style="font-size:11px;font-family:돋움, 굴림;"><font class=small1 color=444444><b>내용</b></td>
