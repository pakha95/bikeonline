...
switch($mode){
	case 'smsPopup': case 'smsBatch':
		$infoMessage = "SMS 발송대상 ".number_format($_GET['totalCount'])."명 중 수신거부회원 혹은 비회원이 <span style='font-weight: bold;'>".number_format($_GET['receiveRefuseCount'])."</span>명 포함되어 있습니다.<br />제외하고 SMS를 발송하시겠습니까?";
	break;
...
<tr>
	...
	<span style="color: red;">수신거부회원 혹은 비회원에게 광고성 정보를 발송시 과태료가 부과될 수 있습니다.</span>
	</td>
</tr>
<tr>
	<td class="buttonArea">
