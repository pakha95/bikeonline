...
<tr>
	<td>배송지 목록</td>
	<td colspan="3">
		<a href="javascript:popup('delivery_list.php?mode=list&mno=<?=$data['m_no']?>',700,550)">
			<img src="../img/btn_delivery_list.png" alt="배송지 목록" title="배송지 목록" />
		</a>
	</td>
</tr>
<tr>
	...
	<?php } ?>
	<img src="../img/btn_send_info.png" style="vertical-align:middle; cursor:pointer; border: 0px;" onclick="javascript:popup('./popup.sms.sendView.php?sms_phoneNumber=<?php echo $data['mobile']; ?>', '700', '500');" />
	<div style="color: #0074BA; margin-top: 3px;"> *수신동의설정 안내메일의 자동발송여부에 따라 회원정보의 수신동의설정 변경 시 해당 회원에게 안내메일이 자동 발송됩니다.</div>
	</td>
</tr>
<tr>
