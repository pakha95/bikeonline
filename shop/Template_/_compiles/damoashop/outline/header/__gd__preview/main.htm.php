<?php /* Template_ 2.2.7 2015/06/28 23:30:16 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/outline/header/main.htm 000004201 */  $this->include_("dataBanner");?>
<a name="top"></a>
...
<?php }?>
			<li><a href="<?php echo url("member/myinfo.php?")?>&&" <?php if($TPL_VAR["useMypageLayerBox"]=='y'){?>onClick="return fnMypageLayerBox(<?php if($GLOBALS["sess"]){?>true<?php }?>);"<?php }?> class="menu"><img src="/shop/data/skin/damoashop/img/main/03mypage.gif"></a></li>
