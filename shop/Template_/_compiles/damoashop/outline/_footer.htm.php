<?php /* Template_ 2.2.7 2017/12/04 18:29:28 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/outline/_footer.htm 000005755 */  $this->include_("dataBanner");
...
<div id=scroll style="position:absolute; padding-top:0px; padding-left:10px;">
	<div style="margin-top:13px;"><a style="cursor: hand;" onclick="window.open('http://www.bikeonline.co.kr/shop/sizechart.html?','sizechart','width=670, height=680, Statusbar=yes, resizable=yes, scrollbars=yes')">
	<img src="/shop/data/skin/damoashop/img/common/size-chart.jpg" alt="어패럴사이즈차트"/></a></div>
	<div style="margin-top:1px;"><a href="http://bikeonline-thai.com" target="_blank"><img src="http://jbsinter2.godohosting.com/banner/bikeonline_thailand_flag.png" style="border:1px solid #dcdcdc;border-radius: 7px;" /></a></div>
