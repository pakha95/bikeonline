<?php /* Template_ 2.2.7 2015/10/11 11:17:26 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/order/nscreen_settle.htm 000014934 */ 
...
<tr>
	...
	<tr>
		<td>주소</td>
		<td><?php echo $TPL_VAR["address"]?> <?php echo $TPL_VAR["address_sub"]?></td>
	</tr>
	</table>
...
//kcp 의 경우 결제 버튼이 kcp 페이지 자체에 있어, 이나무 settleform 을 미리 submit 시켜야 한다.
<?php if($GLOBALS["cfg"]["settlePg"]=='kcp'){?>
