...
<TBODY>
<TR>
<TD style="PADDING-LEFT: 10px" height=60>기타 문의사항이 있으시면, <A href="mailto:<?php echo $TPL_VAR["cfg"]["adminEmail"]?>"><STRONG><FONT color=#585858><?php echo $TPL_VAR["cfg"]["adminEmail"]?></FONT></STRONG></A> 로 연락주시기 바랍니다.<BR><?php echo $TPL_VAR["cfg"]["shopName"]?> 쇼핑몰을 이용해 주셔서 감사합니다. </TD></TR></TBODY></TABLE><!--본문 부분 : End --><!--메일 하단 : Start -->
...
<TR>
<TD style="FONT: 8pt verdana"><FONT color=#585858>Copyright(C) <STRONG><?php echo $TPL_VAR["cfg"]["shopName"]?></STRONG> All right reserved.</FONT></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE><!--메일 하단 : End --></TD></TR></TBODY></TABLE>