<?php /* Template_ 2.2.7 2015/01/28 16:49:46 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/proc/member_social_status.htm 000003906 */ ?>
...
div.sns-connect-status-title {
	margin-top: 15px;
	background: url("/shop/data/skin/damoashop/img/meminfor_sns_01.gif") no-repeat;
	width: 82px;
	height: 23px;
	font-size: 0;
}
...
div.connected-facebook button.btn-facebook-disconnect {
	margin-left: 20px;
	background: url('/shop/data/skin/damoashop/img/meminfor_btn_sns_clear.gif') no-repeat;
	width: 47px;
	height: 18px;
	vertical-align: middle;
}
div.disconnected-sns button.btn-facebook-connect {
	background: url('/shop/data/skin/damoashop/img/meminfor_sns_facebook.gif') no-repeat;
	width: 37px;
	height: 37px;
}
</style>
...
<?php if($TPL_VAR["FacebookSocialMemberConnected"]){?>
					<div class="connected-facebook">
						<img src="/shop/data/skin/damoashop/img/meminfor_sns_ico_facebook.gif" alt="페이스북"/>
