<?php /* Template_ 2.2.7 2017/10/31 19:15:21 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/proc/orderitem.htm 000008448 */ ?>
<style media="screen">
...
<?php }?>
	...
	<td>
	<div><?php echo $TPL_V1["goods_prefix"]?><?php echo $TPL_V1["goodsnm"]?></div>
	<div style="margin:5px 0 5px 0;overflow:hidden;height:1px;background:url(/shop/data/skin/damoashop/img/common/line2.gif) repeat-x top left;"></div>
...
<?php }?>
<?php if($GLOBALS["orderitem_mode"]=="cart"){?>
	<div style="margin:5px 0 5px 0"><a href="javascript:void(0);" onClick="nsGodo_CartAction.editOption('<?php echo $TPL_I1?>');"><img src="/shop/data/skin/damoashop/img/common/btn_check_modify.gif"></a></div>
<?php }?>
	</td>
...
<?php if($GLOBALS["orderitem_mode"]=="cart"){?>
		...
		<tr>
			...
			<td><div style="padding-bottom:2px"><img src="/shop/data/skin/damoashop/img/common/btn_plus.gif" onClick="chg_cart_ea(frmCart['ea[]'],'up',<?php echo $TPL_I1?>)" style="cursor:pointer"></div><img src="/shop/data/skin/damoashop/img/common/btn_minus.gif" onClick="chg_cart_ea(frmCart['ea[]'],'dn',<?php echo $TPL_I1?>)" style="cursor:pointer"></td>
			<td><input type=image src="/shop/data/skin/damoashop/img/common/sbtn_mod.gif"></td>
		</tr>
		</table>
<?php }else{?>
