...
<div style="width:200px; padding-top:10px; border:solid 1px #e0e0e0; border-width:0 1px 1px 1px;">
	...
	<div style="margin:0; padding:15px 15px; text-align:center;">
		...
		<div class="noline"><font class=small color=555555><input name=vLength type=text style="width:20px;text-align:right;font-size:8pt;font-style:돋움;color:e65100" value=0>/90 Bytes</font></div>
		...
		<div style="padding-top:3" class="noline" id="avoidSubmit"><input type="image" src="/shop/data/skin/damoashop/img/common/sid_btn_sms.gif" alt="보내기"></div>
	</div>
	</form>
</div>
