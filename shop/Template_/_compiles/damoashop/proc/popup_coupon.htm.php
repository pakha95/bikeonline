<?php /* Template_ 2.2.7 2015/01/28 16:49:46 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/proc/popup_coupon.htm 000008040 */ ?>
...
<tr>
	<td style="background:#000000; border-bottom:2px solid #DDDDDD; height:40px;"><img src="/shop/data/skin/damoashop/img/common/popup_title_coupon.gif"></td>
</tr>
<tr>
...
<?php }}?>
	...
	<div style="padding:10px" align=center><a href="javascript:window.close()"><img src="/shop/data/skin/damoashop/img/common/btn_confirm_red.gif"></a></div>
	</td>
</tr>


<tr>
	<td valign=bottom align=right style="padding:0 14 6 0;">
		<div style="text-align:left;padding-left:10px;color: #007fc8; font-size: 11px; margin: 3px 0 0 3px">
		* 아래와 같이 정상 결제되지 않은 경우 사용된 쿠폰을 미사용 상태로 변경하여 재사용하실 수 있습니다.<br />
		...
		→ 위치 : 마이페이지 > 주문내역/배송조회 > 결제시도(또는 결제실패) 주문 > 상세보기 > 쿠폰사용취소
		</div>
		<A HREF="javascript:this.close()" onFocus="blur()"><img src="/shop/data/skin/damoashop/img/common/popup_close.gif"></A>
	</td>
</tr>
</table>
</body>
