<?php /* Template_ 2.2.7 2015/01/28 16:49:46 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/mypage/_myBox.htm 000005136 */ ?>
...
<br/>
&nbsp;&nbsp;&nbsp;<a href="javascript: member_grp_pop();"><img src="/shop/data/skin/damoashop/img/common/btn_benefit.gif"></a>
<?php }?>
</td>
<td>
...
<div><img src="/shop/data/skin/damoashop/img/common/benefit_01.gif"></div>
<div style="padding:0 25px 0 30px;width:374px;background:url(/shop/data/skin/damoashop/img/common/benefit_02.gif) repeat-y top left;text-align:left;line-height:150%;font-size:12px;font-family:돋움; color:#464646; letter-spacing:-1; ">
	<div>
...
<div style="background: url('/shop/data/skin/damoashop/img/common/benefit_03.gif'); width:374px; height:75px;">
	<div style="padding-top:25px;"></div>
	<a href="javascript:void(0);" onClick="document.getElementById('MyMemberGrpBpx').style.display='none'"><img src="/shop/data/skin/damoashop/img/common/btn_benefit_check.gif"></a>
</div>
