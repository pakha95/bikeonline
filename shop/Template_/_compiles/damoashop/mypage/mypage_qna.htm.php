<?php /* Template_ 2.2.7 2015/01/28 16:49:46 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/mypage/mypage_qna.htm 000005293 */ 
...
<tr>
	<td><img src="/shop/data/skin/damoashop/img/common/title_mantoman.gif" border=0></td>
</tr>
<TR>
...
<tr height=25 onmouseover=this.style.background="#F7F7F7" onmouseout=this.style.background="">
	<td width=8% align="center"><?php echo $TPL_V1["idx"]?></td>
	<td width=15% align="left"><img src="/shop/data/skin/damoashop/img/common/myqna_answer.gif"></td>
...
<?php if($TPL_V1["authreply"]=='Y'){?>
	<a href="javascript:;" onclick="popup_register( 'reply_qna', '<?php echo $TPL_V1["sno"]?>' );"><img src="/shop/data/skin/damoashop/img/common/btn_reply.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_V1["authmodify"]=='Y'){?>
	<a href="javascript:;" onclick="popup_register( 'mod_qna', '<?php echo $TPL_V1["sno"]?>' );"><img src="/shop/data/skin/damoashop/img/common/btn_modify2.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_V1["authdelete"]=='Y'){?>
    <a href="javascript:;" onclick="popup_register( 'del_qna', '<?php echo $TPL_V1["sno"]?>' );"><img src="/shop/data/skin/damoashop/img/common/btn_delete.gif" border="0" align="absmiddle"></a>
<?php }?>
    </div>
</div>
</div>
...
<a href="javascript:;" onclick="popup_register( 'add_qna' )"><img src="/shop/data/skin/damoashop/img/common/btn_write.gif"></a>
</div>
