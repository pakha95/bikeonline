<?php /* Template_ 2.2.7 2016/11/03 13:08:25 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/mypage/mypage_qna_register.htm 000006648 */ ?>
<html>
<head>
...
<form name=fm method=post action="<?php echo $TPL_VAR["myqnaActionUrl"]?>" onSubmit="return chkEncoding(this)">
...
<tr>
	...
	<div style="width:100%; background:#000000; border-bottom:2px solid #DDDDDD"><img src="/shop/data/skin/damoashop/img/common/popup_title_mantoman.gif"></div>
	<div><img src="/shop/data/skin/damoashop/img/common/space.gif" width=5 height=10></div>


	<CENTER>
	<div><img src="/shop/data/skin/damoashop/img/common/space.gif" width=5 height=5></div>
...
<?php }}?>
		...
		<tr>
			...
			<td>
			<input type=text name=ordno style="width:25%" value="<?php echo $GLOBALS["data"]["ordno"]?>"> <a href="javascript:order_open();"><img src="/shop/data/skin/damoashop/img/common/btn_inquiry_order.gif" align=absmiddle></a>
...
<?php }?>
	...
	<div id="agree-area" style="width:540px; margin:20px auto 0; padding:5px; text-align:left; border:1px solid #DEDEDE;">
...
window.resizeTo(600, 580 + document.getElementById('agree-area').offsetHeight);
</script>
