<?php /* Template_ 2.2.7 2017/10/31 19:14:56 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/mypage/mypage_wishlist.htm 000004199 */ 
...
<tr>
	<td><img src="/shop/data/skin/damoashop/img/common/title_wishlist.gif" border=0></td>
</tr>
<TR>
...
<tr>
	...
	<td>
	<div><a href="<?php echo url("goods/goods_view.php?")?>&goodsno=<?php echo $TPL_V1["goodsno"]?>"><?php echo $TPL_V1["goods_prefix"]?><?php echo $TPL_V1["goodsnm"]?></a> <?php if($TPL_V1["opt"]){?>[<?php echo implode("/",$TPL_V1["opt"])?>]<?php }?></div>
...
<center>
<a href="javascript:act('delItem')"><img src="/shop/data/skin/damoashop/img/common/btn_select_delete.gif"></a>
<a href="javascript:act('cart')"><img src="/shop/data/skin/damoashop/img/common/btn_cartin.gif"></a>
</center>
