<?php /* Template_ 2.2.7 2016/01/21 18:18:41 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/mypage/_myBoxLayer.htm 000004589 */ ?>
<?php if($TPL_VAR["page_cache_enabled"]){?>
<div id="MypageLayerBox" style="z-index:1000;position:absolute;border:1px solid #363636;background:#F6F6F6;width:187px;height:220px;display:none;text-align:center;">

	<div style="float:right;">
		<a href="javascript:void(0);" onClick="document.getElementById('MypageLayerBox').style.display='none';"><img src="/shop/data/skin/damoashop/img/main/close.gif"></a>
	</div>
...
<?php if($GLOBALS["sess"]["grpnm_disp_type"]=='icon'){?><img src="../data/member/icon/<?php echo $GLOBALS["sess"]["grpnm_icon"]?>" align="absbottom"><?php }?>
	...
	<div>
		<a href="<?php echo url("mypage/mypage.php")?>&"><img src="/shop/data/skin/damoashop/img/main/btn_mypage_go.gif"></a>
	</div>
