<?php /* Template_ 2.2.7 2015/01/28 16:49:46 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/mypage/mypage_coupon.htm 000005589 */ 
...
<tr>
	<td><img src="/shop/data/skin/damoashop/img/common/title_coupon.gif" border=0></td>
</tr>
<TR>
...
<table width=100% cellpadding=0 cellspacing=0 border=0>
<tr><td align="center">
<a href="<?php echo url("mypage/mypage_coupon.php?")?>&tab=all"><img src="/shop/data/skin/damoashop/img/common/sale_btn_01<?php echo $GLOBALS["tab01"]?>.gif" alt="전체" id="sale_btn_01" onmouseover="tab_over(1,'on');" onmouseout="tab_over(1,'off');"/></a>&nbsp;
<a href="<?php echo url("mypage/mypage_coupon.php?")?>&tab=wait"><img src="/shop/data/skin/damoashop/img/common/sale_btn_03<?php echo $GLOBALS["tab03"]?>.gif" alt="보유내역" id="sale_btn_03"  onmouseover="tab_over(3,'on');" onmouseout="tab_over(3,'off');"/></a>&nbsp;
<a href="<?php echo url("mypage/mypage_coupon.php?")?>&tab=used"><img src="/shop/data/skin/damoashop/img/common/sale_btn_02<?php echo $GLOBALS["tab02"]?>.gif" alt="사용내역" id="sale_btn_02"  onmouseover="tab_over(2,'on');" onmouseout="tab_over(2,'off');"/></a>
</td></tr>
</table>
...
<!--
	function tab_over(tab, val){
		...
		if(getTab1 != "on")img1.src = "/shop/data/skin/damoashop/img/common/sale_btn_01off.gif";
		if(getTab2 != "on")img2.src = "/shop/data/skin/damoashop/img/common/sale_btn_02off.gif";
		if(getTab3 != "on")img3.src = "/shop/data/skin/damoashop/img/common/sale_btn_03off.gif";

		if(tab == 1){
			if(val == "on")img1.src = "/shop/data/skin/damoashop/img/common/sale_btn_01on.gif"
			else if(getTab1 != "on")img1.src = "/shop/data/skin/damoashop/img/common/sale_btn_01off.gif";
		}else if(tab == 2){
			if(val == "on")img2.src = "/shop/data/skin/damoashop/img/common/sale_btn_02on.gif"
			else if(getTab2 != "on")img2.src = "/shop/data/skin/damoashop/img/common/sale_btn_02off.gif";
		}else if(tab == 3){
			if(val == "on")img3.src = "/shop/data/skin/damoashop/img/common/sale_btn_03on.gif"
			else if(getTab3 != "on")img3.src = "/shop/data/skin/damoashop/img/common/sale_btn_03off.gif";
		}
	}
//-->
</SCRIPT>
...
<img src="/shop/data/skin/damoashop/img/common/btn_paper.gif" onclick="popup('../mypage/paper_coupon.php',350,200)" style="cursor:hand">
</div>
<div style="height:30px"></div>
<?php if($GLOBALS["cfg"]["RecoverCoupon"]=='y'){?>
...
<a href="<?php echo url("mypage/mypage_orderlist.php")?>&" style="font-weight:bold;color: #007fc8;">[주문내역/배송조회 바로가기 >]</b></a>
<?php }?>
</div><!-- End indiv -->
