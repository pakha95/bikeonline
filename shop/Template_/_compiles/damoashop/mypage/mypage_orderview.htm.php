<?php /* Template_ 2.2.7 2017/10/31 19:14:02 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/mypage/mypage_orderview.htm 000040350 */  $this->include_("displayEggBanner");
...
<tr><td><img src="/shop/data/skin/damoashop/img/common/title_orderdetail.gif" border=0></td></tr>
...
<tr>
	...
	<td>
	<a href="<?php echo url("goods/goods_view.php?")?>&goodsno=<?php echo $TPL_V1["goodsno"]?>"><?php echo $TPL_V1["goods_prefix"]?><?php echo $TPL_V1["goodsnm"]?>
...
<?php if($TPL_VAR["deliverycode"]){?>
	<p style='color:blue'> =><?php echo $TPL_VAR["deliverycomp"]?> : <?php echo $TPL_VAR["deliverycode"]?></p>
<?php }?>
	</td>
...
<?php if($TPL_V1["dvno"]=='101'||$TPL_V1["dvno"]=='102'||$TPL_V1["dvno"]=='103'||$TPL_V1["dvno"]=='104'){?>
		<a href="javascript:popup('<?php echo $TPL_VAR["dvUrl"]?><?php echo $TPL_VAR["deliverycode"]?>',1024,720)"><img src="/shop/data/skin/damoashop/img/common/btn_chase.gif"></a>
<?php }elseif($TPL_V1["dvno"]=='105'){?>
		<a href="javascript:popup('mypage_delivery.php?item_sno=<?php echo $TPL_V1["sno"]?>',600,170)"><img src="/shop/data/skin/damoashop/img/common/btn_chase.gif"></a>
<?php }else{?>
		<a href="javascript:popup('mypage_delivery.php?item_sno=<?php echo $TPL_V1["sno"]?>',600,600)"><img src="/shop/data/skin/damoashop/img/common/btn_chase.gif"></a>
<?php }?>
<?php }elseif(!$GLOBALS["set"]["delivery"]["basis"]&&$TPL_VAR["deliverycode"]){?>
<?php if($TPL_V1["dvno"]=='101'||$TPL_V1["dvno"]=='102'||$TPL_V1["dvno"]=='103'||$TPL_V1["dvno"]=='104'){?>
		<a href="javascript:popup('<?php echo $TPL_VAR["dvUrl"]?><?php echo $TPL_VAR["deliverycode"]?>',1024,720)"><img src="/shop/data/skin/damoashop/img/common/btn_chase.gif"></a>
<?php }elseif($TPL_V1["dvno"]=='105'){?>
		<a href="javascript:popup('mypage_delivery.php?ordno=<?php echo $TPL_VAR["ordno"]?>',600,170)"><img src="/shop/data/skin/damoashop/img/common/btn_chase.gif"></a>
<?php }else{?>
		<a href="javascript:popup('mypage_delivery.php?ordno=<?php echo $TPL_VAR["ordno"]?>',600,600)"><img src="/shop/data/skin/damoashop/img/common/btn_chase.gif"></a>
<?php }?>
<?php }?>
<?php if($TPL_V1["istep"]== 4){?><a href="javascript:;" onclick="popup_register( 'add_review', '<?php echo $TPL_V1["goodsno"]?>' )"><img src="/shop/data/skin/damoashop/img/common/btn_review.gif"></a><?php }?>
	</td>
</tr>
...
<div>
	<table width=100% style="border:1px solid #DEDEDE; table-layout:fixed" cellpadding=0 cellspacing=0>
		<tr>
			<td width=150 valign=middle align=center bgcolor="#F3F3F3" style="padding:5px 0"><b>고객상담메모</b></td>
			<td id="orderbox" style="word-wrap:break-word"><?php echo $TPL_VAR["adminmemo"]?></td>
		</tr>
	</table>
</div>
<div style="font-size:0;height:5px"></div>
<div>
	<table width=100% style="border:1px solid #DEDEDE; table-layout:fixed" cellpadding=0 cellspacing=0>
		<tr >
			<td width=150 valign=middle align=center bgcolor="#F3F3F3" style="padding:5px 0;color:red"><b>입금확인</b></td>
			<td id="orderbox" style="word-wrap:break-word">입금이 확인되어 국내 배송 상품은 배송준비중이며, 해외배송 상품은 해외에 주문을 할 예정입니다.</td>
		</tr>
	</table>
	<div style="font-size:0;height:2px"></div>
	<table width=100% style="border:1px solid #DEDEDE; table-layout:fixed" cellpadding=0 cellspacing=0>
		<tr>
			<td width=150 valign=middle align=center bgcolor="#F3F3F3" style="padding:5px 0;color:red"><b>해외주문/배송준비중</b></td>
			<td id="orderbox" style="word-wrap:break-word">해외 제조사 또는 총판사에 주문이 진행중이며 재고가 준비되는대로 국내로 배송을 시작할 예정입니다.<br /> 만약 현지에 재고가 없거나 변동이 있는 경우 고객께 별도 연락 드리겠습니다.<br /> 재고가 있는 경우 운송지에 따라 통상적으로 국내 도착까지 1~3주 정도 소요될 예정입니다.</td>
		</tr>
	</table>
	<div style="font-size:0;height:2px"></div>
	<table width=100% style="border:1px solid #DEDEDE; table-layout:fixed" cellpadding=0 cellspacing=0>
		<tr>
			<td width=150 valign=middle align=center bgcolor="#F3F3F3" style="padding:5px 0;color:red"><b>배송중</b></td>
			<td id="orderbox" style="word-wrap:break-word">운송사에따라 아래와 같이 확인 하실 수 있습니다.<br />
			<b>CJ 대한통운</b><br />
			&nbsp;- 국내에서 고객님께 배송중<br />
			&nbsp;- 미국에서 고객님께 헬멧이 직접 배송중 : 통상적으로 운송시작 3~4일후 추적 가능합니다.<br /><br />
			<b>DHL, UPS, Fedex, USPS, 우체국 EMS</b><br />
			&nbsp;- 미국 바이크온라인 운송창고로 배송중(받는 주소가 Wilmington, DE인 경우)<br />
			&nbsp;- 해외에서 한국 바이크 온라인으로 배송중(받는 주소가 Korea인 경우)<br /><br />
			<b>미국->한국 배송중</b><br />
				&nbsp;- "배송 추적"을 누르시면 고객께서 받으실 예정일을 확인하실 수 있습니다.<br /><span style="color:blue">(국제무역운송인 관계로 실시간 추적은 어렵습니다)</span></td>

		</tr>
	</table>
</div>
<!--
<div align="left" class="stxt delivery" style="padding:5px 0"><dt><font size="2" color="#007FC8">※ 입금확인</font></dt><dd><font color="#007FC8">입금이 확인되어 국내 배송 상품은 배송준비중이며, 해외배송 상품은 해외에 주문을 할 예정입니다.</font></dd><dt><font size="2" color="#007FC8">※ 해외주문/배송 준비중</font></dt><dd><font color="#007FC8">해외 제조사 또는 총판사에 주문이 진행중이며 재고가 준비되는대로 국내로 배송을 시작할 예정입니다.<br /> 만약 현지에 재고가 없거나 변동이 있는 경우 고객께 별도 연락 드리겠습니다.<br /> 재고가 있는 경우 운송지에 따라 통상적으로 국내 도착까지 1~3주 정도 소요될 예정입니다.</font></dd>
<dt><font size="2" color="#007FC8">※ 배송중</font></dt><dd><font color="#007FC8">운송사에따라 아래와 같이 확인 하실 수 있습니다.
CJ 대한통운
- 국내에서 고객님께 배송중

DHL, UPS, Fedex, USPS, 우체국 EMS
- 미국 바이크온라인 운송창고로 배송중(받는 주소가 Wilmington, DE인 경우)
- 해외에서 한국 바이크 온라인으로 배송중(받는 주소가 Korea인 경우)

우체국  택배
- 미국 바이크온라인 운송창고에서 한국 바이크온라인으로 배송중
- 해외에서 고객님께 직접 배송중(헬멧)</font></dd>
</div>
-->
<div style="font-size:0;height:2px"></div>
<div style="border:1px solid #DEDEDE;"><img  id="orderbox"  src="/shop/data/skin/damoashop/img/common/delivery_process2.png" border="0" data-pin-nopin="true"></div>
...
<tr>
	...
	<tr>
		<td>우편번호</td>
		<td><?php echo $TPL_VAR["zonecode"]?> (<?php echo $TPL_VAR["zipcode"]?>)</td>
	</tr>
	<tr>
		<td>주소</td>
...
<tr>
	...
	<tr>
		<td>총주문금액</td>
		<td><span id="paper_goodsprice"><?php echo number_format($TPL_VAR["goodsprice"])?></span>원
<?php if($TPL_VAR["diffPrice"]){?><font color=red></span>(상품조정금액 <?php echo number_format($TPL_VAR["diffPrice"])?>원)</font><?php }?>
		</td>
	</tr>
<?php if($TPL_VAR["item"][ 0]['todaygoods']!='y'){?>
	...
	<tr>
		<td>상품할인</td>
		<td>- <span id="paper_memberdc"><?php echo number_format($TPL_VAR["goodsDc"])?></span>원</td>
	</tr>
	<tr>
		<td>쿠폰할인</td>
...
<?php if($TPL_VAR["enuri"]){?>
	<tr>
		<td>에누리</td>
		<td><span id="paper_memberdc"><?php echo number_format($TPL_VAR["enuri"]* - 1)?></span>원</td>
	</tr>
<?php }?>
	<tr>
		<td>배송비</td>
	...
	<tr>
		<td>결제금액</td>
		<td><b><span id="paper_settlement"><?php echo number_format($TPL_VAR["prn_settleprice"])?></span>원</b> <?php if($GLOBALS["prnSettleEtcMsg"]){?><?php echo $GLOBALS["prnSettleEtcMsg"]?><?php }?></td>
	</tr>
<?php if($TPL_VAR["canceled_price"]){?>
	<tr>
		<td>취소완료금액</td>
		<td><?php echo number_format($TPL_VAR["canceled_price"]* - 1)?>원</td>
	</tr>
<?php }?>
<?php if($TPL_VAR["canceling_price"]){?>
	<tr>
		<td>취소접수금액</td>
		<td><?php echo number_format($TPL_VAR["canceling_price"])?>원</td>
	</tr>
<?php }?>
<?php if($TPL_VAR["canceling_RealPrnSettlePrice"]){?>
	<tr>
		<td>취소시 결제금액</td>
		<td><?php echo number_format($TPL_VAR["canceling_RealPrnSettlePrice"])?>원</td>
	</tr>
<?php }?>
	</table>
<?php if($TPL_VAR["settleInflow"]=='payco'){?>
	<div style="color: #007fc8; font-size: 11px; margin: 3px 0 0 3px">※ 본 주문은 페이코 서비스로 결제되었습니다.<br/>세부 결제내역은 페이코 구매내역을 확인하여 주십시오</div>
<?php }else{?>
...
<?php }elseif($TPL_VAR["settlekind"]=="t"){?>
	<tr>
		<td>결제방법</td>
		<td><?php echo $TPL_VAR["paycoSettleType"]?></td>
	</tr>
...
<?php if($TPL_VAR["words"]=='end'){?>
		<span style="line-height:150%; color:6C6C6C;"><?php echo $GLOBALS["guide"]?></span>
<?php }else{?>
...
<?php }?>
		<script>
		_ID('taxapply').style.display = "<?php if($TPL_VAR["taxmode"]=='taxapp'&&$TPL_VAR["words"]!='end'){?>block<?php }else{?>none<?php }?>";
		</script>
		<!-- 세금계산서 신청폼 : end -->
...
<?php if($GLOBALS["pg"]["receipt"]=="Y"&&$TPL_VAR["settlekind"]!="c"&&$TPL_VAR["settlekind"]!="h"&&$TPL_VAR["settleprice"]>= 1&&$TPL_VAR["taxmode"]!='taxview'&&$TPL_VAR["settleInflow"]!='payco'){?><!-- 현금영수증 발급 -->
...
<tr>
	...
	<td id="orderbox">
	<div><a href="javascript:okcashbag();"><img src="/shop/data/skin/damoashop/img/common/btn_okcash.gif"></a></div>
...
<?php if(($TPL_VAR["step"]&&!$TPL_VAR["step2"]&&in_array($TPL_VAR["settlekind"],array('c','o','v'))&&$TPL_VAR["settleInflow"]!='payco')||($GLOBALS["cfg"]["particular"]=='y'&&$TPL_VAR["step"]>=$GLOBALS["cfg"]["particularPermit"])){?><!-- 거래 영수증 발급 -->
<table width=100% style="border:1px solid #DEDEDE" cellpadding=0 cellspacing=0>
<tr>
	<td width=150 valign=top align=right bgcolor="#F3F3F3"></td>
	<td id="orderbox">
	...
	<table>
	<col width=100>
<?php if($TPL_VAR["step"]&&!$TPL_VAR["step2"]&&in_array($TPL_VAR["settlekind"],array('c','o','v'))&&$TPL_VAR["settleInflow"]!='payco'){?>
	<tr>
		<td>거래영수증</td>
		<td>
...
<?php }?>
<?php }?>
<?php if($TPL_VAR["settleprice"]!=$TPL_VAR["prn_settleprice"]){?>
		<br/><div style="color: #007fc8; font-size: 11px;">※상품부분취소 등 결제금액의 변동이 있는 경우, <br/><span style='font-weight:bold;color:#000000'>변경전 결제금액(<?php echo number_format($TPL_VAR["settleprice"])?>원)</span>으로 조회해주세요.</div>
<?php }?>
		</td>
	</tr>
<?php }?>
<?php if($GLOBALS["cfg"]["particular"]=='y'&&$TPL_VAR["step"]>=$GLOBALS["cfg"]["particularPermit"]){?>
	<tr>
		<td>거래명세표</td>
		<td>
		<a href="javascript:void(0)" onClick="window.open('mypage_particular.php?ordno=<?php echo $TPL_VAR["ordno"]?>','','width=750,height=900,scrollbars=1')">거래명세표출력</a>
		</td>
	</tr>
<?php }?>
	</table>
...
<?php if($TPL_VAR["step"]== 0&&$TPL_VAR["step2"]== 0){?>
	<a href="javascript:chkCancel();"><img src="/shop/data/skin/damoashop/img/common/btn_order_cancel.gif" border=0></a>
<?php }?>
<?php if($GLOBALS["cfg"]["reOrder"]=='y'){?>
	<a href="<?php echo url("mypage/settle.php?")?>&ordno=<?php echo $TPL_VAR["ordno"]?>" ><img src="/shop/data/skin/damoashop/img/common/btn_reorder.gif" border=0></a>
<?php }?>
<?php if($TPL_VAR["step2"]>= 50&&$GLOBALS["cfg"]["RecoverCoupon"]=='y'&&$TPL_VAR["recovery_coupon"]=='n'){?>
	<a href="javascript:chkReCoupon();"><img src="/shop/data/skin/damoashop/img/common/btn_coupon_recover.gif" border=0></a>
<?php }?>
</div>
<div style="font-size:0;height:5px"></div>
</div><!-- End indiv -->
...
// 쿠폰복원 150129 추가
function chkReCoupon() {
	var f = document.frmOrder;
	if(confirm('쿠폰 사용내역을 취소하고 미사용 상태로 변경하시겠습니까?')) {
		f.mode.value = 'recoverCoupon';
		f.submit();
	}
}
