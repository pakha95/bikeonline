<?php /* Template_ 2.2.7 2015/01/28 16:49:40 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/goods/goods_qna_list.htm 000005256 */ 
...
<table border=0 cellpadding=0 cellspacing=0>
	<tr>
		<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_04.gif) no-repeat;" nowrap width="163" height="24"></TD>
		<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_04_bg.gif) repeat-x;" width='90%'><b>(<?php echo $TPL_VAR["qna_count"]?>)</b></TD>
		<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_04_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
	</tr>
</table>
...
<a href="<?php echo url("goods/goods_qna.php")?>&" target="_parent"><img src="/shop/data/skin/damoashop/img/common/info_btn_totalview.gif"></a>
<a href="javascript:;" onclick="popup_register( 'add_qna', '<?php echo $GLOBALS["goodsno"]?>' )"><img src="/shop/data/skin/damoashop/img/common/btn_qna.gif"></a>
</div>
