<?php /* Template_ 2.2.7 2017/10/31 19:12:17 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/goods/goods_review.htm 000009026 */ 
...
<script>location.href='/shop/main/index.php';</script>
...
<tr>
	<td><img src="/shop/data/skin/damoashop/img/common/title_review.gif" border=0></td>
</tr>
<TR>
...
<tr>
	...
	<tr>
		<td><img src="/shop/data/skin/damoashop/img/common/search.gif" border=0></td>
		...
		<tr>
			...
			</select><input type="text" NAME="sword" value="<?php echo $_GET['sword']?>" size=47 class="linebg"><input type="image" src="/shop/data/skin/damoashop/img/common/btn_search.gif" align=absmiddle>
			</td>
		</tr>
		</table>
		</td>
...
<?php if($TPL_V1["type"]!='Q'&&$TPL_V1["notice"]== 0){?>
				<TD rowspan=2 width="27" valign="top" style="padding-top:3px;"><img src="/shop/data/skin/damoashop/img/common/ico_a.gif"></TD>
<?php }?>
				<TD style="padding-top:5"><?php if($TPL_V1["notice"]== 0&&$TPL_V1["goodsno"]){?><span style="font-weight:bold;"><?php echo $TPL_V1["goods_prefix"]?><?php echo $TPL_V1["goodsnm"]?></span> <a href="<?php echo url("goods/goods_view.php?")?>&goodsno=<?php echo $TPL_V1["goodsno"]?>"><img src="/shop/data/skin/damoashop/img/common/btn_goodview2.gif" align=absmiddle></a><?php }?></TD>
			</TR>
...
<div class="pagediv"><?php echo $TPL_VAR["pg"]->page['navi']?></div>
	...
	<div style="text-align: right;">
		<img src="/shop/data/skin/damoashop/img/common/btn_review.gif" style="cursor: pointer" onclick="popup_register('add_review', null, null);"/>
	</div>
