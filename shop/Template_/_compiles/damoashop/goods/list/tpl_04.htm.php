<?php /* Template_ 2.2.7 2015/11/01 01:41:25 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/goods/list/tpl_04.htm 000004513 */ 
...
<?php if(!$TPL_V1["strprice"]){?><?php if($TPL_V1["price"]){?><div class='goods_price'><b><?php echo number_format($TPL_V1["price"])?>원</b><?php if($TPL_V1["special_discount_amount"]){?><img src='/shop/data/skin/damoashop/img/icon/goods_special_discount.gif'><?php }?></div><?php }?><?php if($TPL_V1["soldout_price_string"]){?><?php echo addslashes($TPL_V1["soldout_price_string"])?><?php }?><?php if($TPL_V1["soldout_price_image"]){?><?php echo addslashes($TPL_V1["soldout_price_image"])?><?php }?><?php }else{?><?php echo $TPL_V1["strprice"]?><?php }?><?php if($TPL_V1["icon"]){?><div style='padding-right:5px;'><?php echo $TPL_V1["icon"]?></div><?php }?>\
<?php if($TPL_V1["coupon"]){?><div class=eng><b style='color:red'><?php echo $TPL_V1["coupon"]?><font class=small><b>원</b></font></b> <img src='/shop/data/skin/damoashop/img/icon/good_icon_coupon.gif' align=absmiddle></div><?php }?>\
</div>\
</div>\
";
...
<table width='659px' cellpadding='0' cellspacing='0' border='0' style="padding:48px 21px">
<tr align='center'>
<td valign="top" ><div style="position:relative;"><div style="position:absolute;left:-1px;top:90px;z-index:10"><img src="/shop/data/skin/damoashop/img/main/arrow_left.gif" onmouseover="<?php echo $TPL_VAR["id"]?>.direct(-1)" onclick="<?php echo $TPL_VAR["id"]?>.go()" class=hand></div></div></td>
<td valign="top">
<script><?php echo $TPL_VAR["id"]?>.exec();</script>
</td>
<td valign="top"><div style="position:relative;"><div style="position:absolute;left:-54px;top:90px;z-index:10"><img src="/shop/data/skin/damoashop/img/main/arrow_right.gif" onmouseover="<?php echo $TPL_VAR["id"]?>.direct(1)" onclick="<?php echo $TPL_VAR["id"]?>.go()" class=hand></div></div></td>
</tr>
</table>
