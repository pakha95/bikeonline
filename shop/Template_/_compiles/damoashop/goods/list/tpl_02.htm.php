<?php /* Template_ 2.2.7 2017/10/31 19:13:05 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/goods/list/tpl_02.htm 000003993 */ 
...
<tr>
	...
	<td>
<?php if($TPL_V1["coupon"]){?><div class=eng><b style="color:red"><?php echo $TPL_V1["coupon"]?></b> <img src="/shop/data/skin/damoashop/img/icon/good_icon_coupon.gif" align=absmiddle></div><?php }?>
<?php if($TPL_V1["brandnm"]){?><div style="padding:5px 0" class=stxt><b><?php echo $TPL_V1["brandnm"]?></b></div><?php }?>
<?php if($TPL_V1["goodsnm"]){?><div style="padding:5px 0"><a href="<?php echo $TPL_V1["goods_view_url"]?>"><?php echo $TPL_V1["goods_prefix"]?><?php echo $TPL_V1["goodsnm"]?></a></div><?php }?>
<?php if($TPL_V1["shortdesc"]){?><div style="padding-bottom:5px" class=stxt><?php echo nl2br($TPL_V1["shortdesc"])?></div><?php }?>
	<div>
<?php if($TPL_V1["soldout_icon"]){?><div style="padding:3px"><?php if($TPL_V1["soldout_icon"]=='custom'){?><img src="../data/goods/icon/custom/soldout_icon"><?php }else{?><img src="/shop/data/skin/damoashop/img/icon/good_icon_soldout.gif"><?php }?></div><?php }?>
...
<?php if($TPL_V1["oriPrice"]){?><div style="color:gray"><strike><?php echo number_format($TPL_V1["oriPrice"])?></strike> ↓</div><?php }?>
		<b style="color:#C94C00"><?php echo number_format($TPL_V1["goodsDiscountPrice"])?>원</b> <?php if($TPL_V1["special_discount_amount"]){?><img src="/shop/data/skin/damoashop/img/icon/goods_special_discount.gif"><?php }?>
<?php }else{?>
<?php if($TPL_V1["price"]){?>
<?php if($TPL_V1["consumer"]){?><div style="color:gray"><strike><?php echo number_format($TPL_V1["consumer"])?></strike> ↓</div><?php }?>
		<b style="color:#C94C00"><?php echo number_format($TPL_V1["price"])?>원</b> <?php if($TPL_V1["special_discount_amount"]){?><img src="/shop/data/skin/damoashop/img/icon/goods_special_discount.gif"><?php }?>
<?php }?>
