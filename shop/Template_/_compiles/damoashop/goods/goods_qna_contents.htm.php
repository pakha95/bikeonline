<?php /* Template_ 2.2.7 2015/01/28 16:49:40 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/goods/goods_qna_contents.htm 000002009 */ ?>
...
<?php if($TPL_VAR["parent"]==$TPL_VAR["sno"]&&!$TPL_VAR["notice"]){?>
	<a href="javascript:;" onclick="popup_register( 'reply_qna', '<?php echo $TPL_VAR["goodsno"]?>', '<?php echo $TPL_VAR["sno"]?>' );"><img src="/shop/data/skin/damoashop/img/common/btn_reply.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_VAR["authmodify"]=='Y'){?>
	<a href="javascript:;" onclick="popup_register( 'mod_qna', '<?php echo $TPL_VAR["goodsno"]?>', '<?php echo $TPL_VAR["sno"]?>' );"><img src="/shop/data/skin/damoashop/img/common/btn_modify2.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_VAR["authdelete"]=='Y'){?>
	<a href="javascript:;" onclick="popup_register( 'del_qna', '<?php echo $TPL_VAR["goodsno"]?>', '<?php echo $TPL_VAR["sno"]?>' );"><img src="/shop/data/skin/damoashop/img/common/btn_delete.gif" border="0" align="absmiddle"></a>
<?php }?>
	</div>
	</td>
</tr>
