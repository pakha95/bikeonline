...
if (is_array($TPL_VAR["pdfLoop"])) $TPL_pdfLoop_1=count($TPL_VAR["pdfLoop"]); else if (is_object($TPL_VAR["pdfLoop"]) && in_array("Countable", class_implements($TPL_VAR["pdfLoop"]))) $TPL_pdfLoop_1=$TPL_VAR["pdfLoop"]->count();else $TPL_pdfLoop_1=0;?>
...
<?php if($TPL_VAR["special_discount_amount"]){?>
	<b><strike><span id=price><?php echo number_format($TPL_VAR["price"])?></span>원</strike></b>
<?php }else{?>
...
<tr>
	<th>딜러가격 :</th>
	<td style="font-weight:bold"><?php echo number_format($TPL_VAR["price"]-round($TPL_VAR["price"]*$TPL_VAR["dealera_price"]/ 1000)* 1000)?>원/<?php echo number_format($TPL_VAR["price"]-round($TPL_VAR["price"]*$TPL_VAR["dealerb_price"]/ 1000)* 1000)?>원/<?php echo number_format($TPL_VAR["price"]-round($TPL_VAR["price"]*$TPL_VAR["dealerc_price"]/ 1000)* 1000)?>원</span></b></td>
</tr>
<?php }?>
<?php if($TPL_VAR["special_discount_amount"]){?>
<tr>
	<th>딜러가격 :</th>
	<td style="font-weight:bold"><?php echo number_format($TPL_VAR["price"]-$TPL_VAR["special_discount_amount"])?>원</span></b></td>
</tr>
<?php }?>
...
<?php }?>
<?php if(!$TPL_VAR["stock"]&&$TPL_VAR["gd_reserve"]){?>
	<tr><th>배송기간 :</th><td>평균<span id=reserve> <?php echo $TPL_VAR["gd_reserve"]?> </span>영업일 소요</td></tr>
<?php }?>
...
<?php if($TPL_VAR["stock"]){?>
<tr><th>재고수량 :</th><td><?php echo $TPL_VAR["stock"]?>&nbsp;개</td></tr>
<?php }?>
<?php if(!$GLOBALS["opt"]){?>
<tr><th>구매수량 :</th>
<td>
...
<div style="padding:1 0 2 0"><img src="/shop/data/skin/damoashop/img/common/btn_plus.gif" onClick="chg_cart_ea(frmView.ea,'up')" style="cursor:pointer"></div>
<div><img src="/shop/data/skin/damoashop/img/common/btn_minus.gif" onClick="chg_cart_ea(frmView.ea,'dn')" style="cursor:pointer"></div>
</div>
...
return {
	...
	add : function() {
		...
		if (chkGoodsForm(form)) {
			...
			html += '<div style="padding:1 0 2 0"><img src="/shop/data/skin/damoashop/img/common/btn_multioption_ea_up.gif" onClick="nsGodo_MultiOption.ea(\'up\',\''+key+'\');" style="cursor:pointer"></div>';
			html += '<div><img src="/shop/data/skin/damoashop/img/common/btn_multioption_ea_down.gif" onClick="nsGodo_MultiOption.ea(\'down\',\''+key+'\');" style="cursor:pointer"></div>';
			html += '</div>';
			td.innerHTML = html;

			// 옵션가격
			_data.opt_price = _data.price-_data.special_discount_amount;
			for (var i=0,m=_data.addopt.length;i<m ;i++ )
			{
				tmp = _data.addopt[i].split('^');
			...
			html += '<a href="javascript:void(0);" onClick="nsGodo_MultiOption.del(\''+key+'\');return false;"><img src="/shop/data/skin/damoashop/img/common/btn_multioption_del.gif"></a>';
			td.innerHTML = html;
...
<div style="font-size:12px;text-align:right;padding:10px 20px 10px 0;border-bottom:1px solid #D3D3D3;margin-bottom:5px;">
	<img src="/shop/data/skin/damoashop/img/common/btn_multioption_br.gif" align="absmiddle"> 총 금액 : <span style="color:#E70103;font-weight:bold;" id="el-multi-option-total-price"></span>
</div>
</div>
<!-- / -->
...
<a href="../setGoods/?cody=<?php echo $TPL_VAR["goodsno"]?>"><img src="/shop/data/skin/damoashop/img/common/btn_codylink.gif"></a>
<?php }?>
<!-- 각종 버튼 -->
...
<a href="javascript:act('../order/order')"><img src="/shop/data/skin/damoashop/img/common/btn_direct_buy.gif"></a>
<a href="javascript:cartAdd(frmView,'<?php echo $TPL_VAR["cartCfg"]->redirectType?>')"><img src="/shop/data/skin/damoashop/img/common/btn_cart.gif"></a>
<a href="javascript:act('../mypage/mypage_wishlist')"><img src="/shop/data/skin/damoashop/img/common/btn_wish_m_un.gif"></a>
<?php }else{?>
<a href="javascript:buyableMember('<?php echo $TPL_VAR["goodsBuyable"]?>')"><img src="/shop/data/skin/damoashop/img/common/btn_direct_buy.gif"></a>
<a href="javascript:buyableMember('<?php echo $TPL_VAR["goodsBuyable"]?>')"><img src="/shop/data/skin/damoashop/img/common/btn_cart.gif"></a>
<a href="javascript:buyableMember('<?php echo $TPL_VAR["goodsBuyable"]?>')"><img src="/shop/data/skin/damoashop/img/common/btn_wish_m_un.gif"></a>
<?php }?>
<?php }?>
<?php }?>
<?php if($TPL_VAR["stocked_noti"]){?>
<a href="javascript:fnRequestStockedNoti('<?php echo $TPL_VAR["goodsno"]?>');"><img src="/shop/data/skin/damoashop/img/stocked_noti/btn_alarm_2.gif"></a>
<?php }?>
<a href="<?php echo url("goods/goods_list.php?")?>&category=<?php echo $_GET["category"]?>"><img src="/shop/data/skin/damoashop/img/common/btn_list.gif"></a>
</div>
...
<table border=0 cellpadding=0 cellspacing=0>
<tr>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_01.gif) no-repeat;" nowrap width="120" height="24"></TD>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_01_bg.gif) repeat-x;" width='90%'></TD>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_01_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
</tr>
</table>
...
<table>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/common/coupon_txt.gif"></td>
	<td>
	<table border=0 cellpadding=0 cellspacing=0>
	<tr>
...
<?php }else{?>
	<div style="font:bold 12px tahoma;color:#FF0000;text-align:center;padding:19px 40px 0 0;width:140px;height:54px;background:url('/shop/data/skin/damoashop/img/common/coupon0<?php echo ($TPL_V1["coupon_img"]+ 1)?>.gif');" onmouseover="cp_explain('<?php echo $TPL_I1?>');" onmouseout="cp_explain_close('<?php echo $TPL_I1?>');"><?php echo $GLOBALS["r_couponAbility"][$TPL_V1["ability"]]?><?php if(substr($TPL_V1["price"], - 1)!="%"){?><?php echo number_format($TPL_V1["price"])?>원<?php }else{?><?php echo $TPL_V1["price"]?><?php }?></div>
<?php }?>
...
<!-- 상세 설명 -->
<div id=contents style="width:100%;padding:10 10 10 10;overflow:hidden;">
<table width=100%>
	<tr><td><?php echo $TPL_VAR["longdesc"]?></td></tr>
		<!-- PDF다운로드 -->
<?php if($TPL_pdfLoop_1){$TPL_I1=-1;foreach($TPL_VAR["pdfLoop"] as $TPL_V1){$TPL_I1++;?>
		<tr><TD nowrap width="150" style="text-align:left" height="24"><a href="<?php echo $TPL_V1?>" download title="<?php echo $TPL_I1+ 1?>"><img src="/shop/data/skin/damoashop/img/common/bar_detail_download_<?php echo $TPL_I1+ 1?>.png" class="hand" width="140" height="24"></a></TD></tr>
<?php }}?>
...
<table border=0 cellpadding=0 cellspacing=0>
<tr>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_02.gif) no-repeat;" nowrap width="137" height="24"></TD>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_02_bg.gif) repeat-x;" width='90%'></TD>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_02_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
</tr>
</table>
...
<table border=0 cellpadding=0 cellspacing=0>
<tr>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_l.gif) no-repeat;" nowrap width="10" height="24"></TD>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_c.gif) repeat-x; font-weight:bold;" width='100%'><?php echo $TPL_V1["title"]?></TD>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_r.gif) no-repeat;" nowrap width="10" height="24"></TD>
</tr>
</table>
...
<table border=0 cellpadding=0 cellspacing=0>
<tr>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_06.gif) no-repeat;" nowrap width="112" height="24"></TD>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_06_bg.gif) repeat-x;" width='90%'></TD>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_06_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
</tr>
</table>
<div style="width:100%;padding:10 10 10 10;overflow:hidden">
...
<!--
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
...
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>바이크 온라인의 국내재고상품을 제외한 모든 상품은 해외배송의 특성상 최대 15영업일입니다.(입금확인일 제외)</td></tr>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>만약 품절의 사유로 15영업일내에 고객님께 도착이 어려운 경우 고객님께 별도로 연락드립니다.</td></tr>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>배송일에는 대한민국과 현지 국가의 공휴일은 포함되지 않습니다.</td></tr>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>국내배송료는 2,500원 입니다. 100,000원 이상 구매시 무료배송입니다.(도서,산간,오지 일부지역은 배송비가 추가됩니다.)</td></tr>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>해외배송료는 제품가격에 포함되어 있습니다.(단, 헬멧의 경우 통관비용이 별도로 발생할 수 있습니다.)</td></tr>

</table>

</div>
<div style="width:100%;padding-bottom:20px;"><img src="/shop/data/skin/damoashop/img/common/delivery_process2.png" border="0" data-pin-nopin="true"></div>
<!-- 교환및반품안내 -->
<table border=0 cellpadding=0 cellspacing=0>
<tr>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_05.gif) no-repeat;" nowrap width="198" height="24"></TD>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_05_bg.gif) repeat-x;" width='90%'></TD>
	<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_05_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
</tr>
</table>
<div style="width:100%;padding:10 10 10 10;overflow:hidden">
...
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>해외 배송의 특성상 상품 청약철회 가능시간은 입금한 날의 19시까지입니다.</td></tr>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>주문 당일 19시 기준으로 마감후 해외에 주문이 들어간 후에는 무료 철회가 불가능하며 소정의 수수료(25%)가 고객님께 부과됩니다.(제품의 하자,배송오류는 제외)</td></tr>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>단, 19시 이후 입금/카드 결제한경우는 다음 영업일 19시까지 청약철회를 할 수 있습니다.</td></tr>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>구매대행 상품인 헬멧과 특별주문 상품은 수수료를 부담하시더라도 원칙적으로 청약철회를 할 수 없습니다.</td></tr>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>상품을 받으신 후 상품 택(tag)제거 또는 개봉, 착용등으로 상품 가치 훼손 시에는 교환 및 반품이 불가능합니다.</td></tr>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>상품의 오배송, 사이즈 상이 등의 착오인 경우에는 무료 교환이 가능합니다.</td></tr>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>Gimoto 등의 주문제작상품의 경우, 주문완료 시점으로부터 1주후에는 수수료를 부담하신다고 하여도 교환 및 반품이 불가능 합니다.</td></tr>
<tr>
	<td><img src="/shop/data/skin/damoashop/img/dot.gif"></td>
	<td>재고 상품의 경우, 청약철회 및 교환은 왕복 택배비만 부담하시면 언제든지 수수료 없이 가능합니다.</td></tr>
</table>

</div>

<!-- 결제안내
<div style="height:26px; padding-top:10"><img src="/shop/data/skin/damoashop/img/common/bar_detail_07.gif"></div>
...
<tr>
<td width="4" height="271" valign="top" background="/shop/data/skin/damoashop/img/common/page02_detail_blt.gif" style="background-repeat:no-repeat"></td>
<td  width="285" height="271" valign="top" background="/shop/data/skin/damoashop/img/common/page02_detail.gif"></td>
</tr>
</table>
...
<?php if($TPL_VAR["jQueryUse"]){?>
<script type="text/javascript" src="<?php echo $TPL_VAR["jQueryPath"]?>"></script>
<script type="text/javascript" src="<?php echo $TPL_VAR["jQueryUiPath"]?>"></script>
<script type="text/javascript">jQuery.noConflict();</script>
<link href="<?php echo $TPL_VAR["jQueryUiCssPath"]?>" rel="stylesheet" type="text/css"/>
<?php if($TPL_VAR["hashtag"]){?>
	<script type="text/javascript" src="<?php echo $TPL_VAR["jQueryHashtagJsPath"]?>"></script>
	<script type="text/javascript">
