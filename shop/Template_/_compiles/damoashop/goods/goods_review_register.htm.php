<?php /* Template_ 2.2.7 2016/11/03 13:06:58 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/goods/goods_review_register.htm 000010679 */ 
...
function add(){
	...
	tmpHTML = "<input type=file name='file[]' style='width:50%' class=line> <a href=\"javascript:del('"+"tr_"+(tr_num)+"')\"><img src='/shop/data/skin/damoashop/img/common/btn_upload_minus.gif' align=absmiddle></a>";
...
<form name="form_review" id="form_review" method=post action="<?php echo url("goods/indb.php")?>&" enctype="multipart/form-data" onSubmit="return chkEncoding(this)">
...
<tr>
	...
	<div style="width:100%; background:#000000; border-bottom:2px solid #DDDDDD"><img src="/shop/data/skin/damoashop/img/common/popup_title_review.gif"></div>
...
<?php if($TPL_I1== 0){?>
					<a href="javascript:add()"><img src="/shop/data/skin/damoashop/img/common/btn_upload_plus.gif" align=absmiddle></a>
<?php }else{?>
<?php if($TPL_V1){?>
					<a href="javascript:del('tr_<?php echo $TPL_I1?>',1)"><img src="/shop/data/skin/damoashop/img/common/btn_upload_minus.gif" align=absmiddle></a>
<?php }else{?>
					<a href="javascript:del('tr_<?php echo $TPL_I1?>')"><img src="/shop/data/skin/damoashop/img/common/btn_upload_minus.gif" align=absmiddle></a>
<?php }?>
<?php }?>
<?php }?>
<?php if($TPL_V1){?>
