<?php /* Template_ 2.2.7 2016/01/20 14:38:26 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/goods/goods_review_list.htm 000006557 */ 
...
<table border=0 cellpadding=0 cellspacing=0>
	<tr>
		<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_03.gif) no-repeat;" nowrap width="100" height="24"></TD>
		<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_03_bg.gif) repeat-x;" width='90%'><b>(<?php echo $TPL_VAR["review_count"]?>)</b></TD>
		<TD style="background: URL(/shop/data/skin/damoashop/img/common/bar_detail_03_right.gif) no-repeat;" nowrap width="10" height="24"></TD>
	</tr>
</table>
...
<?php if($TPL_V1["type"]=='Q'){?>
	<td><div style="background-image: url(/shop/data/skin/damoashop/img/common/icon_review.gif); background-repeat:no-repeat;background-position:left 6px;padding:3px 0px 0px 12px;"><?php echo $TPL_V1["subject"]?><?php if($TPL_V1["attach"]){?>&nbsp;&nbsp;<img src="/shop/data/skin/damoashop/img/disk_icon.gif" align="absmiddle"><?php }?></div></td>
<?php }else{?>
	<td style="padding-left:5px"><div style="background-image: url(/shop/data/skin/damoashop/img/common/ico_a.gif); background-repeat:no-repeat;background-position:left 3px;padding:3px 0px 0px 27px;"> <?php echo $TPL_V1["subject"]?><?php if($TPL_V1["attach"]){?>&nbsp;&nbsp;<img src="/shop/data/skin/damoashop/img/disk_icon.gif" align="absmiddle"><?php }?></div></td>
<?php }?>
...
<?php if($TPL_V1["authreply"]=='Y'){?>
	<a href="javascript:;" onclick="popup_register( 'reply_review', '<?php echo $TPL_V1["goodsno"]?>', '<?php echo $TPL_V1["sno"]?>' );"><img src="/shop/data/skin/damoashop/img/common/btn_reply.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_V1["authmodify"]=='Y'){?>
	<a href="javascript:;" onclick="popup_register( 'mod_review', '<?php echo $TPL_V1["goodsno"]?>', '<?php echo $TPL_V1["sno"]?>' );"><img src="/shop/data/skin/damoashop/img/common/btn_modify2.gif" border="0" align="absmiddle"></a>
<?php }?>
<?php if($TPL_V1["authdelete"]=='Y'){?>
	<a href="javascript:;" onclick="popup_register( 'del_review', '<?php echo $TPL_V1["goodsno"]?>', '<?php echo $TPL_V1["sno"]?>' );"><img src="/shop/data/skin/damoashop/img/common/btn_delete.gif" border="0" align="absmiddle"></a>
<?php }?>
</div>
</div>
<?php }}?>
...
<a href="<?php echo url("goods/goods_review.php")?>&" target="_parent"><img src="/shop/data/skin/damoashop/img/common/info_btn_totalview.gif"></a>
<a href="javascript:;" onclick="popup_register( 'add_review', '<?php echo $GLOBALS["goodsno"]?>' )"><img src="/shop/data/skin/damoashop/img/common/btn_review.gif"></a>
</div>
