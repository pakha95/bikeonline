<?php /* Template_ 2.2.7 2015/01/28 16:49:42 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/goods/popup_request_stocked_noti.htm 000004360 */ 
...
<tr>
	<td style="background-image: url(/shop/data/skin/damoashop/img/stocked_noti/topbg.jpg); height:41px; color:#ffffff; font-family: 돋움; font-weight: bold; font-size: 15px; padding-left: 10px"><?php echo $TPL_VAR["goodsnm"]?></td>
</tr>
<tr>
...
<tr>
	<td style="height:50px" align="center"><a href="javascript:selectOption(true)"><img src="/shop/data/skin/damoashop/img/stocked_noti/btn_allchoice.gif" /></a> <a href="javascript:selectOption(false)"><img src="/shop/data/skin/damoashop/img/stocked_noti/btn_allchoice_no.gif" /></a></td>
</tr>
<?php }?>
<tr>
...
<tr>
	<td align="center"><input type="image" src="/shop/data/skin/damoashop/img/stocked_noti/btn_alarm.gif" /></td>
</tr>
</table>
</form>
<script type="text/javascript">
