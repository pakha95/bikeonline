<?php /* Template_ 2.2.7 2018/09/21 16:07:47 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/popup/standard.htm 000002759 */ ?>
<style>
.text-stroke {
...
<TR>
  ...
  <TABLE cellpadding=0 cellspacing=0 border=0>
  	<TR>
  		<TD ><!-- <img src="/shop/data/skin/damoashop/img/main/popup_01.gif"> -->
  			<div style="http://www.bikeonline.co.kr/shop/data/skin/damoashop/img/banner/godo_banner1433315562.jpg">
  			<br>
  			<h2 class="text-stroke" style="text-align:center">추석연휴간 휴무안내</h1>
  			<br>
  			<h3 style="line-height:2.1em">
				<p>9월 21일 금요일부터 9월25일 화요일까지 추석연휴로 인해</p>
				<p>국제운송 및 국내택배발송이 불가하여</p>
				<p>예정된 배송기간보다 최대 1주일가량 지연될 수 있습니다.</p>
				<p>불편을 드려 죄송합니다.</p>
				<p>9월 26일부터 정상영업합니다.</p>
				<p>감사합니다.</p>
  			</h3>
  			<br>
  			<h3>바이크 온라인</h3>
  	...
  	<tr><td height=21 background="/shop/data/skin/damoashop/img/main/popup_02.gif" align=right class=stxt><font color="#FFFFFF"><b>오늘 하루 보이지 않음</b></font><input type=checkbox onClick="controlCookie( '<?php echo $_GET['code']?>', this )"></td></tr>
  </TABLE>
