<?php /* Template_ 2.2.7 2015/01/28 16:49:46 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/member/find_pwd.htm 000005036 */ ?>
...
<div><img src="/shop/data/skin/damoashop/img/common/pw_01.gif" border=0></div>
<div style="border:1px solid #DEDEDE;" class="hundred">
<table width=100% cellpadding=0 cellspacing=0 border=0>
<tr>
	<td style="border:5px solid #F3F3F3;padding:10;">

	<div style="float:left; width:130"><img src="/shop/data/skin/damoashop/img/common/pw_02.gif" border=0></div>
	...
	<tr>
		...
		<td rowspan=4 class=noline><input type="image" src="/shop/data/skin/damoashop/img/common/pw_btn.gif" tabindex=6></td>
	</tr>
	<tr>
...
<tr>
	<td style="border:5px solid #F3F3F3;padding:10;">
		...
		<tr>
			<td><br>
			<img src="/shop/data/skin/damoashop/img/ipin/Regist_box_icon.gif"/> <font color='5d5d5d'>회원 가입시 사용 하신 본인확인 인증 수단을 선택하시고 필요한 사항을 입력하세요 </font>
		</td>
		</tr>
		<tr height="10">
			<td></td>
...
<a href="<?php echo url("member/find_id.php")?>&"><img src="/shop/data/skin/damoashop/img/common/pw_btn_id.gif"></a>
</div>
