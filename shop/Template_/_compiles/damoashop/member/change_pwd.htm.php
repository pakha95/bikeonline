	...
	<div class="contents">
		...
		<input type="hidden" name="passwordSkin" value="Y"><!-- 비밀번호 작성 규칙 보완 스킨패치 여부 -->
			...
			<div class="form">
				<table border="0">
				<tr>
					<th><img src="/shop/data/skin/damoashop/img/common/h1_n_pass.gif" alt="새 비밀번호" /><th>
				...
				<tr>
					<th><img src="/shop/data/skin/damoashop/img/common/h1_n_pass01.gif" alt="새 비밀번호 확인" /><th>
