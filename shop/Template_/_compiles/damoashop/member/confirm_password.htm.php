<?php /* Template_ 2.2.7 2015/01/28 16:49:46 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/member/confirm_password.htm 000001992 */ ?>
...
<div id="cp_body">
	...
	<div id="cp_title"><img src="/shop/data/skin/damoashop/img/common/h_pass_rember.gif" /></div>
	...
	<div id="cp_button">
		<input type="image" src="/shop/data/skin/damoashop/img/common/btn_gr_enter.gif" />
		<a href="javascript:;" onclick="history.go(-1);"><img src="/shop/data/skin/damoashop/img/common/btn_gr_cancle.gif" border="0" /></a>
	</div>
	</form>
</div>