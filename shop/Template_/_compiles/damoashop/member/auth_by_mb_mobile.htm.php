<?php /* Template_ 2.2.7 2015/01/28 16:49:46 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/member/auth_by_mb_mobile.htm 000002754 */ ?>
<html>
<head>
<title>휴대폰 인증</title>
...
.password-auth-form-wrapper h1 {width:100%;height:43px;margin:0;background:url('/shop/data/skin/damoashop/img/common/h_change_phone.gif') no-repeat top left;text-indent:-1000px;}
...
<div class="password-auth-form-wrapper">
	...
	<div class="contents">
		...
		<p>
		회원정보상에 등록되어 있는 고객님의 휴대폰 번호로 인증번호가 전송되었습니다.
		전송된 인증번호를 입력하여 주세요.
		...
		<form name="certForm" method="post" action="" onsubmit="return chkForm2(this)">
			...
			<div class="form">
				<img src="/shop/data/skin/damoashop/img/common/h1_authentication.gif" alt="인증번호" />
