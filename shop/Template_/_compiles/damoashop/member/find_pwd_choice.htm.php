<?php /* Template_ 2.2.7 2015/01/28 16:49:46 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/member/find_pwd_choice.htm 000008496 */ ?>
...
var nsGodo_PasswordFinder = function() {
	return {
		...
		changePwd : function(pwd,m_id,token,passwordSkin) {

			gd_ajax({
				url : '../member/indb.find_pwd.php',
				type : 'POST',
				param : '&mode=change&pwd='+encodeURIComponent(pwd)+'&m_id='+m_id+'&token='+token+'&passwordSkin='+passwordSkin,
...
<tr>
	<td><img src="/shop/data/skin/damoashop/img/common/title_pwsearch.gif" border=0></td>
</tr>
<TR>
...
<tr align="center" valign="middle" height="131">
	<td colspan="2"><div style="background:url(/shop/data/skin/damoashop/img/common/img_c_re_pass.gif); height:111px; width:401px;" /></div></td>
</tr>
...
<?php if($TPL_VAR["temp_email"]){?>
		<div class="method-wrap">
			<div class="method" style="background-image:url(/shop/data/skin/damoashop/img/common/img_re_email.gif);">
				<div class="cont">
					<?php echo $TPL_VAR["temp_email"]?>

					<a href="javascript:void(0);" onClick="<?php if($TPL_VAR["temp_email"]){?>selectOption(1);<?php }else{?>alert('이메일 주소가 올바르지 않아, 전송할 수 없습니다.');<?php }?>"><img src="/shop/data/skin/damoashop/img/common/btn_get_authnum.gif" align="absmiddle" /></a>
				</div>
			</div>
		</div>
<?php }?>
...
<?php if($TPL_VAR["temp_mobile"]){?>
		<div class="method-wrap">
			<div class="method" style="background-image:url(/shop/data/skin/damoashop/img/common/img_re_phone.gif);">
				<div class="cont">
					<?php echo $TPL_VAR["temp_mobile"]?>

					<a href="javascript:void(0);" onClick="<?php if($TPL_VAR["temp_mobile"]){?>selectOption(2);<?php }else{?>alert('휴대폰 번호가 올바르지 않아, 전송할 수 없습니다.');<?php }?>"><img src="/shop/data/skin/damoashop/img/common/btn_get_authnum.gif" align="absmiddle" /></a>
				</div>
			</div>
		</div>
<?php }?>
