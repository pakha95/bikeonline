<?php /* Template_ 2.2.7 2015/01/28 16:49:46 /www/jbsinttr8192_godo_co_kr/shop/data/skin/damoashop/service/faq.htm 000004743 */ 
...
<tr>
	<td><img src="/shop/data/skin/damoashop/img/common/title_faq.gif" border=0></td>
</tr>
<TR>
...
<tr>
	...
	<tr>
		<td height=40 style="padding-left:10"><img src="/shop/data/skin/damoashop/img/common/faq_01.gif" align=absmiddle><input type="text" NAME="sword" value="<?php echo $_GET['sword']?>" size=32></td>
		<td class=noline><input type="image" src="/shop/data/skin/damoashop/img/common/btn_search.gif"></td>
	</tr>
	</table>
...
<?php if($TPL_V1["descant"]!=''){?>
	...
	<tr valign="top">
		<th style="color:#bf0000;width:40; padding-top:1"><img src="/shop/data/skin/damoashop/img/common/faq_q.gif"></th>
...
<?php }?>
	<table cellpadding=0 cellspacing=0 border=0>
	<tr valign="top">
		<th style="color:#0000bf;width:40; padding-top:1"><img src="/shop/data/skin/damoashop/img/common/faq_a.gif"></th>
