<?php /* Template_ 2.2.7 2015/08/20 18:11:20 /www/jbsinttr8192_godo_co_kr/shop/data/skin_mobileV2/light/goods/cart.htm 000016948 */ ?>
...
#option-modify-btn {background:#f35151; height:30px; width:94px; border:none; text-align:center; font-size:13px; font-weight:bold; color:#ffffff; font-family:dotum; border-radius:3px;}
#option-cancel-btn {background:#808591; height:30px; width:94px; border:none; text-align:center; font-size:13px; font-weight:bold; color:#ffffff; font-family:dotum; border-radius:3px;}

.cnt_minus_btn {background:url("/shop/data/skin_mobileV2/light/common/img/new/btn_amount_.png") top left no-repeat; background-size:26px 26px; height:26px; width:26px; border:none; text-align:center; color:#ffffff; margin-left:3px; float:right;}
.cnt_plus_btn {background:url("/shop/data/skin_mobileV2/light/common/img/new/btn_amount_plus.png") top left no-repeat; background-size:26px 26px; height:26px; width:26px; border:none; text-align:center; color:#ffffff; margin-left:3px;  float:right;}
...
<?php if(count($TPL_VAR["cart"]->item)){?>
	<div class="ord_area">
		<div id="all-ord-btn" onclick="nsGodo_CartAction.order();return false;">주문하기</div>
	</div>
<?php }?>
