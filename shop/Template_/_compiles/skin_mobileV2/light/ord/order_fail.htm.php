<?php /* Template_ 2.2.7 2015/08/20 18:22:22 /www/jbsinttr8192_godo_co_kr/shop/data/skin_mobileV2/light/ord/order_fail.htm 000003251 */ ?>
...
section#order_fail .sub_title .point {width:4px; height:22px; background:url('/shop/data/skin_mobileV2/light/common/img/bottom/icon_guide.png') no-repeat center left; float:left; margin-right:7px;}
...
section#order_fail .btn_center .submit{border:none; background:url('/shop/data/skin_mobileV2/light/common/img/layer/btn_red01_off.png') no-repeat; color:#FFFFFF; font-size:14px; width:94px; height:34px; float:left; font-family:dotum; line-height:34px;}
section#order_fail .btn_center .cancel{border:none; background:url('/shop/data/skin_mobileV2/light/common/img/layer/btn_black01_off.png') no-repeat; color:#FFFFFF; font-size:14px; width:94px; height:34px; float:right; font-family:dotum; line-height:34px;}
...
<?php if($TPL_VAR["settleInflow"]=="payco"){?>
	<tr>
		<td>결제방법</td>
		<td><?php echo $TPL_VAR["paycoType"]?></td>
	</tr>
<?php }?>
