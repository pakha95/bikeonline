<?php /* Template_ 2.2.7 2015/08/20 18:20:25 /www/jbsinttr8192_godo_co_kr/shop/data/skin_mobileV2/light/ord/order_end.htm 000005233 */ ?>
...
section#order_end .sub_title .point {width:4px; height:22px; background:url('/shop/data/skin_mobileV2/light/common/img/bottom/icon_guide.png') no-repeat center left; float:left; margin-right:7px;}
...
section#order_end .btn_center .submit{border:none; background:url('/shop/data/skin_mobileV2/light/common/img/layer/btn_red01_off.png') no-repeat; color:#FFFFFF; font-size:14px; width:94px; height:34px; float:left; font-family:dotum; line-height:34px;}
section#order_end .btn_center .cancel{border:none; background:url('/shop/data/skin_mobileV2/light/common/img/layer/btn_black01_off.png') no-repeat; color:#FFFFFF; font-size:14px; width:94px; height:34px; float:right; font-family:dotum; line-height:34px;}
