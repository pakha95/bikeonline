<?php /* Template_ 2.2.7 2017/10/31 19:09:16 /www/jbsinttr8192_godo_co_kr/shop/data/skin_mobileV2/light/myp/orderlist.htm 000003483 */ 
...
section#norderlist .sub_title .point {width:4px; height:22px; background:url('/shop/data/skin_mobileV2/light/common/img/bottom/icon_guide.png') no-repeat center left; float:left; margin-right:7px;}
section#norderlist table{border:none; border-top:solid 1px #dbdbdb;width:100%; margin-bottom:20px;}
section#norderlist table td{padding:8px 0px 8px 10px; vertical-align:middle; border-bottom:solid 1px #dbdbdb;word-break:break-all;}
...
section#norderlist .goods-nm{color:#353535; font-weight:bold; fonst-size:14px; margin-bottom:5px; overflow:hidden; }
section#norderlist .goods-price{color:#f03c3c; font-size:12px;}
section#norderlist .ord_more_btn{background:url('/shop/data/skin_mobileV2/light/common/img/nmyp/btn_view_off.png') no-repeat; width:73px; height:25px; border:none; color:#FFFFFF; text-align:center;line-height:25px; float:right;}
section#norderlist .ord_more_btn:active;{background:url('/shop/data/skin_mobileV2/light/common/img/nmyp/btn_view_on.png') no-repeat;}

section#norderlist .more-btn {width:300px; margin:auto; text-align:center; height:35px; color:#ffffff; line-height:35px; font-size:15px; font-weight:bold; background:#808591; border-radius:3px; font-family:dotum; margin-top:15px;}
</style>
...
<tr>
	<th>상품명</th>
	<td class="goods-nm"><?php echo $TPL_V1["goods_prefix"]?><?php echo $TPL_V1["goodsnm"]?></td>
</tr>
<tr>
	<th>주문일시</th>
