<?php /* Template_ 2.2.7 2016/01/20 13:30:48 /www/jbsinttr8192_godo_co_kr/shop/data/skin_mobileV2/light/myp/menu_list.htm 000008272 */ ?>
...
section#mypageinfo .top_level {height:33px; line-height:33px; background:url('/shop/data/skin_mobileV2/light/common/img/nmyp/bdtit_bg.png') repeat-x; font-size:12px; color:#4d4d4d; padding-left:14px;}
...
.mypageinfo-view-benefit { background:url('/shop/data/skin_mobileV2/light/common/img/nmyp/btn_view_off.png') no-repeat; font-weight:bold; font-size:12px; color:#FFFFFF; width:73px; height:25px; border:none;}
.mypageinfo-view-benefit:active { background:url('/shop/data/skin_mobileV2/light/common/img/nmyp/btn_view_on.png') no-repeat; }
