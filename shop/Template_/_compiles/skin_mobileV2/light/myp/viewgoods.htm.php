<?php /* Template_ 2.2.7 2017/11/01 00:15:34 /www/jbsinttr8192_godo_co_kr/shop/data/skin_mobileV2/light/myp/viewgoods.htm 000023003 */ 
...
.goods_order_title #cancel-goods-btn:active{
	background:url("/shop/data/skin_mobileV2/light/common/img/nmyp/btn_close_on.png") no-repeat;
}
...
section#viewgoods .goods-area .goods-item .goods-btn .del-btn{width:100%; height:21px; width:31px; background:url("/shop/data/skin_mobileV2/light/common/img/new/btn_delete.png") no-repeat; background-size:31px 21px; float:left;}
section#viewgoods .goods-area .goods-item .goods-btn .cart-order-btn{width:100%; height:21px; width:56px; background:url("/shop/data/skin_mobileV2/light/common/img/new/btn_order.png") no-repeat; background-size:56px 21px; float:right; cursor:pointer;}
section#viewgoods .goods-area .goods-item .goods-btn .cart-order-btn:active{background:url("/shop/data/skin_mobileV2/light/common/img/nlist/btn_order_on.png") no-repeat; cursor:pointer;}
...
<?php }?>
	<div class="goods-item" <?php if(($TPL_I1+ 1)% 3== 1||($TPL_I1+ 1)% 3== 2){?> style="margin-right:5%;" <?php }?> >
		...
		<div class="goods-nm">
			<a href="../goods/view.php?goodsno=<?php echo $TPL_V1["goodsno"]?>"><?php echo $TPL_V1["goods_prefix"]?><?php echo $TPL_V1["goodsnm"]?></a>
		</div>
