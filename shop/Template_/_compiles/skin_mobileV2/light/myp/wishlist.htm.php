<?php /* Template_ 2.2.7 2017/11/01 00:23:10 /www/jbsinttr8192_godo_co_kr/shop/data/skin_mobileV2/light/myp/wishlist.htm 000006507 */ 
...
.goods-area .goods-list-item {height:80px;padding:10px;background:#FFFFFF; border-bottom:solid 1px #e5e5e5;}
.goods-area .goods-list-item-gray {background:#FFFFFF;}
.goods-area .goods-list-item .goods-list-chk{width:20px; height:80px; float:left; line-height:80px;}
.goods-area .goods-list-item .goods-list-chk input[type=checkbox]{width:10px;}
.goods-area .goods-list-item .goods-list-img{width:80px; height:80px; border:solid 1px #dbdbdb; float:left; }
...
.goods-area .goods-list-item .goods-list-info .goods-nm{color:#222222; font-weight:bold; fonst-size:14px; margin-bottom:5px; overflow:hidden;text-overflow:ellipsis;white-space:nowrap; }
...
.goods-area .goods-list-item .goods-list-arrow{width:15px; height:21px; background:url("/shop/data/skin_mobileV2/light/common/img/nlist/arrow01.png") no-repeat; float:right; margin-top:40px;}
</style>
