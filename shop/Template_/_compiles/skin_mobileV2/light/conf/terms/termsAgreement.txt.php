<?php /* Template_ 2.2.7 2015/06/25 21:25:24 /www/jbsinttr8192_godo_co_kr/shop/conf/terms/termsAgreement.txt 000018388 */ ?>
이용약관

제1조(목적) 

이 약관은 <?php echo $GLOBALS["cfg"]['compName']?> 회사(전자거래 사업자)가 운영하는 <?php echo $GLOBALS["cfg"]['shopName']?> 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. 
※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」 


제2조(정의) 

① "몰"이란 <?php echo $GLOBALS["cfg"]['compName']?> 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다. 
...
제10조 (계약의 성립) 
"JBS/바이크 온라인"은 수입쇼핑몰형과 수입대행형 서비스 이용과 관련하여 이용자와 아래의 절차를 통해 판매 및 수입대행 계약을 체결합니다.

1. 수입 쇼핑몰형
   가. 회원이 JBS 회원가입 후 회원이 수입 쇼핑몰형애서 상품을 구매하여 서비스요금 결제시 JBS와 회원간에 판매계약이 성립합니다. 
   나. JBS와 이용자의 계약성립은 해외 인터넷 쇼핑몰에서의 구매 및 결제 등 수입대행 전과정과 국제운송 및 수입통관, 국내 수취처 인도까지의 운송 전 과정을 JBS에게 일임하였음을 의미합니다.

2. 수입 대행형
   가. 이용자가 JBS 사이트내 수입 대행형몰에 있는 상품에 대하여 수입대행에 따르는 비용결제를 통해 수입대행을 의뢰하고 이에 대해 JBS에게 서비스 요금 결제시 회원과 JBS간에 수입대행계약이 성립됩니다.
   나. JBS와 회원의 계약성립은 해외 인터넷 쇼핑몰에서의 구매 및 결제, 국제운송까지의 과정을 JBS에 일임 하였음을 의미하며, 또한 회원은 수입통관 등의 진행에 있어 JBS의 요청이 있을 경우 이를 이행하겠다는 동의로 간주합니다. 
   다. 수입 대행형은 고객께서 직접 통관 및 국내운송을 하셔야 하며, 결제금액에 통관료, 관세 및 부가세등이 포함되어 있지 않기때문에 제품의 가치에 따라 고객께서 해당 비용등을 납부하실 수 있습니다.
...
① "몰"은 이용자의 구매신청이 있는 경우 이용자에게 이용자의 이메일로 수신확인통지를 합니다.
② 수신확인통지를 받은 이용자는 의사표시의 불일치등이 있는 경우에는 수신확인통지를 받은 후 해당 영업일 이내 구매신청 변경 및 취소를 요청할 수 있고 "몰"은 배송전에 이용자의 요청이 있는 경우에는 지체없이 그 요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한 경우에는 제15조의 청약철회 등에 관한 규정에 따릅니다. 
...
② "몰"은 이용자가 구매한 재화에 대해 배송수단, 수단별 배송비용 부담자, 수단별 배송기간 등을 명시합니다. 만약 "몰"이 약정 배송기간을 초과한 경우에는 그로 인한 이용자의 손해를 배상하여야 합니다. 다만 "몰"이 고의·과실이 없음을 입증한 경우 또는 15영업일 이내에 배송지연의 통보를 한 경우에는 그러하지 아니합니다. 


제14조(환급) 

"몰"은 이용자가 구매신청한 재화등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 5영업일 이내 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 3영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다. 


제15조(청약철회 등) 

① "몰"과 재화등의 구매에 관한 계약을 체결한 이용자는 수신확인의 통지를 받은 날이내에는 청약의 철회를 할 수 있습니다.(휴일인 경우 다음 영업일/오후7시 이후 결제건의 경우 다음 영업일) 
...
③ 청약철회등의 경우 공급받은 재화등의 반환에 필요한 비용은 이용자가 부담합니다. "몰"은 이용자에게 정상적인 취소인 경우 청약철회등을 이유로 위약금 또는 손해배상을 청구하지 않습니다. 다만 청약 체결 당일 7시이후 해외에 주문이 들어간 후이거나, 단순 변심, 사이즈 착오등의 청약 철회인 경우 해외배송의 특성상 25%의 수수료를 이용자가 부담합니다. 
④ 이용자가 재화등을 제공받을때 발송비를 부담한 경우에 "몰"은 청약철회시 오배송인 경우 "몰"이 부담하며, 단순변심, 사이즈착오의 경우 "이용자"가 부담합니다. 
