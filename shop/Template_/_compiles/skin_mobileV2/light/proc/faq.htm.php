<?php /* Template_ 2.2.7 2013/07/22 16:59:57 /www/jbsinttr8192_godo_co_kr/shop/data/skin_mobileV2/light/proc/faq.htm 000004293 */ 
...
.faq .hide .arrow { float:right; width:15px; height:33px; background:url(/shop/data/skin_mobileV2/light/common/img/info/icon_arrow_down.png) no-repeat center; }
.faq .show .trigger { background:none; color:#436693; }
.faq .show .arrow { float:right; width:15px; height:33px; background:url(/shop/data/skin_mobileV2/light/common/img/info/icon_arrow_up.png) no-repeat center; }
...
.faq .question { width:16px; height:14px; background:url(/shop/data/skin_mobileV2/light/common/img/nmyp/icon_question.png) no-repeat; float:left; margin-right:5px; }
.faq .answer { width:16px; height:14px; background:url(/shop/data/skin_mobileV2/light/common/img/nmyp/icon_answer.png) no-repeat; float:left; margin-right:5px; }

#btn_faq_more_box { text-align:center; margin-top:12px; }
#btn_faq_more { background:url(/shop/data/skin_mobileV2/light/common/img/nlist/btn_more_off.png) no-repeat; width:296px; height:38px; border:none; font-size:14px; color:#FFFFFF; font-weight:bold; cursor:pointer; }
 </style>
