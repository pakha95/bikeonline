<?php /* Template_ 2.2.7 2014/11/22 18:11:46 /www/jbsinttr8192_godo_co_kr/shop/data/skin/standard/outline/_footer.htm 000005431 */  $this->include_("dataBanner");
...
<div id=scroll style="position:absolute; padding-top:10px; padding-left:80px;">
<?php if($TPL_VAR["setState"]=='Y'&&$TPL_VAR["Banner"]!=''){?>
<div style="text-align:left;"><?php echo $TPL_VAR["Banner"]?></div>
<?php }else{?>
<div class="sc_bn"><!-- 맨오른쪽_스크롤배너 (배너관리에서 수정가능) --><?php if((is_array($TPL_R1=dataBanner( 43))&&!empty($TPL_R1)) || (is_object($TPL_R1) && in_array("Countable", class_implements($TPL_R1)) && $TPL_R1->count() > 0)) {foreach($TPL_R1 as $TPL_V1){?><?php echo $TPL_V1["tag"]?><?php }}?></div>
<?php }?>
...
<div style="width:90px;">
	<div><img src="/shop/data/skin/standard/img/common/wing_bn_top_myview.jpg" border=0></div>
...
<?php if($TPL_VAR["page_cache_enabled"]){?>
			<div id="template-today-goods" style="display: none;">
				<a href="<?php echo url("goods/goods_view.php?")?>&goodsno="></a>
...
<?php }?>
	...
	<tr><td style="text-align:center;padding:4px 0"><a href="javascript:gdscroll(-107)" onfocus=blur()><img src="/shop/data/skin/standard/img/common/wing_bt_prew.gif" border=0></a> <a href="javascript:gdscroll(107)" onfocus=blur()><img src="/shop/data/skin/standard/img/common/wing_bt_next.gif" border='0'></a></td></tr>
	</table>
</div>
...
<div align="center" style="padding-top:10px;"><a href="#top"><img src="/shop/data/skin/standard/img/common/wing_bt_top.jpg" width="30" height="30"></a></div>
</div>
